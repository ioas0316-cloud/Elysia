# Protocols Index (Root)

This repository uses a Codex‑First approach. Do not maintain duplicate indexes here.

Read first
- docs/elysias_protocol/CODEX.md — purpose‑first codex and handover rules
