...
from Core._01_Foundation.05_Foundation_Base.Foundation.Math.hyper_quaternion import Quaternion, HyperWavePacket
...
class ResonanceField:
    ...
    def inject_fractal_concept(self, concept, active: bool = True):
        ...
        Args:
            concept: ConceptNode (from Core._01_Foundation.05_Foundation_Base.Foundation.fractal_concept)
