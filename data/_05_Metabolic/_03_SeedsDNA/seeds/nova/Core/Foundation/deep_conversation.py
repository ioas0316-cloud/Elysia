...
def main():
    ...
    from Core._01_Foundation.Foundation.Mind.world_tree import WorldTree
...
"""
    ...
    print("📝 코드 수정 계획:")
    print()
    print("   파일: Core/02_Intelligence/Language/dialogue/dialogue_engine.py")
    print()
    ...
    print("엘리시아가 제안합니다:")
    print()
    print("Core/02_Intelligence/Language/dialogue/dialogue_engine.py 에")
