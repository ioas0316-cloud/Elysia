...
# Core Dependencies
try:
    from Core._01_Foundation.Foundation.gemini_api import generate_text
    HAS_API = True
except ImportError:
    HAS_API = False
...
class RefactorPlanner:
    ...
    def create_plan(self, file_path: str, issues: List[CodeIssue]) -> Optional[ModificationPlan]:
        ...
        backup_path = f"Core/04_Evolution/Evolution/Backups/{Path(file_path).stem}_{timestamp}.py.bak"
...
class SelfModificationEngine:
    ...
    사용법:
        ...
        result = engine.improve("Core/02_Intelligence/Intelligence/Will/free_will_engine.py")
    """
...
def self_improve(file_path: str, auto_apply: bool = False) -> Dict[str, Any]:
    ...
    Example:
        result = self_improve("Core/02_Intelligence/Intelligence/Will/free_will_engine.py")
        print(result["diff"])  # 변경 사항 확인
        
        # 자동 적용
        result = self_improve("Core/02_Intelligence/Intelligence/Will/free_will_engine.py", auto_apply=True)
    """
    engine = SelfModificationEngine()
