...
from Core._01_Foundation.Foundation.Physics.time_compression import TimeCompressionEngine, GravityWell
from Core._01_Foundation.Foundation.Math.octonion import Octonion
