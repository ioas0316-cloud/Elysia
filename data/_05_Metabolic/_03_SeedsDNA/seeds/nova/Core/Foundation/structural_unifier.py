...
class StructuralUnifier:
    ...
    def scan_resonance(self) -> Dict[str, Any]:
        ...
        from Core._01_Foundation.Foundation.resonance_field import ResonanceField, PillarType
        ...
        for source, target in connections:
            ...
            if target in field.nodes:
                ...
                # Try to find partial match (e.g. Core._01_Foundation.Foundation -> Foundation)
                parts = target.split('.')
    ...
    def propose_realignment(self) -> List[UnificationProposal]:
        ...
        ideal_locations = {
            Purpose.FOUNDATION: "Core/01_Foundation/Foundation",
            Purpose.INTELLIGENCE: "Core/02_Intelligence/Intelligence",
            Purpose.MEMORY: "Core/02_Intelligence/Memory",
            Purpose.INTERFACE: "Core/03_Interaction/Interface",
            Purpose.EVOLUTION: "Core/04_Evolution/Evolution",
            Purpose.CREATIVITY: "Core/04_Evolution/Creativity",
            Purpose.ETHICS: "Core/01_Foundation/Ethics",
            Purpose.SYSTEM: "Core/05_Systems/System",
