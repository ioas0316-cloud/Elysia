...
from Core._02_Intelligence.Intelligence.tool_discovery import ToolDiscoveryProtocol
...
class ReasoningEngine:
    ...
    def __init__(self):
        ...
        from Core._03_Interaction.Interface.dialogue_interface import DialogueInterface
