...
from Core._02_Intelligence.Intelligence.ollama_bridge import ollama
from Core._01_Foundation.Foundation.korean_wave_converter import korean_wave
from Core._01_Foundation.Foundation.ether import ether, Wave
...
print("  - Ollama Bridge: Core/02_Intelligence/Intelligence/ollama_bridge.py")
print("  - 한글 파동: Core/02_Intelligence/Language/korean_wave_converter.py")
