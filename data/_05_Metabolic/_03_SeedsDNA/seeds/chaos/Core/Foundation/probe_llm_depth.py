...
import logging
from Core._01_Foundation.Foundation.Mind.local_llm import create_local_llm
from Core._04_Evolution.Evolution.Evolution.Life.resonance_voice import ResonanceEngine
