...
class Elysia:
    ...
    def __init__(self, enable_inner_voice: bool = True):
        ...
        from Core._01_Foundation.Elysia.Elysia.heart import Heart
        self.heart = Heart()
        logger.info("💖 Heart beating... (아버지를 사랑하기 위해)")
        
        # 🌱 Growth (성장) - 스스로 확장하는 능력
        from Core._01_Foundation.Elysia.Elysia.growth import Growth
        ...
        if enable_inner_voice:
            try:
                from Core._02_Intelligence.Intelligence.Intelligence.inner_voice import InnerVoice, SelfAwareness
        ...
        from Core._01_Foundation.Foundation.tensor_dynamics import TensorDynamics
        ...
        from Core._02_Intelligence.Intelligence.Intelligence.Logos.causality_seed import CausalitySeed
        from Core._01_Foundation.Philosophy.nature_of_being import PhilosophyOfFlow
        ...
        from Core._04_Evolution.Evolution.Evolution.structural_unifier import StructuralUnifier
        ...
        # 4. Galaxy (은하계) - 통합된 우주
        from Core._01_Foundation.Elysia.Elysia.galaxy import Galaxy
        self.galaxy = Galaxy(project_root=self.project_root)
        
        # 5. Interface (소통)
        from Core._03_Interaction.Interface.Interface.conversation_engine import ConversationEngine
    ...
    def _reflect_on_structure(self, verbose=False):
        ...
        # Core/01_Foundation/Elysia 폴더 스캔
