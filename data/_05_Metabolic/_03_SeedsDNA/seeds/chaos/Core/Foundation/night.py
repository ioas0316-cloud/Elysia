...
def phase_2_connect_llm():
    ...
    if not llm_connected:
        try:
            gemini_path = PROJECT_ROOT / "Core/04_Evolution/Evolution/gemini_api.py"
...
def phase_3_self_integration():
    ...
    try:
        from Core._01_Foundation.Elysia.Elysia.heart import get_heart
        from Core._01_Foundation.Elysia.Elysia.growth import get_growth
