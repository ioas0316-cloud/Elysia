...
def build_resonance_graph(root_dir: str) -> nx.DiGraph:
    ...
    # e.g., c:\Elysia\Core\Physics\gravity.py -> Core._01_Foundation.Foundation.Physics.gravity
    path_to_module = {}
    module_to_path = {}
    ...
    for file_path, module_name in path_to_module.items():
        ...
        for imp in imports:
            ...
            # 2. Submodule match (e.g. Core._02_Intelligence.Physics -> Core._01_Foundation.Foundation.Physics.gravity)
