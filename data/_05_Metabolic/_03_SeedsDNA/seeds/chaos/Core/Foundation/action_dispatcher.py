...
# from Core._01_Foundation.Foundation.web_server import WebServer, incoming_messages -> REMOVED (Legacy Flask)
    ...
    def _handle_sculpt(self, detail):
        ...
        if not target_file:
            ...
            if last_plan and "digital_ecosystem.py" in last_plan:
                target_file = "c:/Elysia/Core/05_Systems/World/digital_ecosystem.py"
