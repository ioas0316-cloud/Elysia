...
from Core._01_Foundation.Foundation.wave_semantic_search import WaveSemanticSearch

if TYPE_CHECKING:
    from Core._01_Foundation.Foundation.unified_knowledge_system import (
...
class WaveKnowledgeIntegration:
    ...
    def _auto_load_memory_files(self):
        ...
        memory_paths = [
            "Core/03_Interaction/Interface/elysia_core_memory.json",
            "Core/01_Foundation/Foundation/memory_stream.json",
