...
def main():
    ...
    # 1. 자율 개선 엔진 초기화
    print("🔧 자율 개선 엔진 초기화...")
    from Core.World.Evolution.Autonomy.autonomous_improver import AutonomousImprover, ImprovementType
    from Core.World.Evolution.Growth.Evolution.Evolution.auto_fix_system import AutoFixSystem
