...
from Core.L6_Structure.M8_Ternary.ternary_logic import TernaryBit, TernaryGates
from Core.L6_Structure.M8_Ternary.ternary_computer import TernaryComputer
