...
replacements = {
    ...
    r'\bCore\.System\b': 'Core.L1_Foundation.M5_System',
    r'\bCore\.World\b': 'Core.L4_Causality.M3_Mirror',
    ...
    r'\bCore\.L5_Mental\.Intelligence\b': 'Core.L5_Mental.M1_Cognition',
    ...
    r'\bCore\.L1_Foundation\.Foundation\.Foundation\b': 'Core.L1_Foundation.M1_Keystone',
    r'\bCore\.L1_Foundation\.Foundation\.Ethics\.Ethics\b': 'Core.L1_Foundation.M1_Keystone.Ethics'
}
