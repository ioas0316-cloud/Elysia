...
replacements = {
    # Nested Sub-package Fixes (High Priority)
    ...
    r'Core\.L6_Structure\.M3_Sphere\.wave_dna': 'Core.L6_Structure.M3_Sphere.wave_dna', # Verify path
    
    # Generic Layer Mappings (from v4)
...
def main():
    base_dir = r"c:\Elysia"
    print(f"🚀 Final Fractal Import Reconciler (v5) at {base_dir}...")
