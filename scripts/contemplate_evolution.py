...
from Core.Foundation.purpose_discovery_engine import PurposeDiscoveryEngine, DimensionalPerspective
from Core.Intelligence.thought_space import ThoughtSpace, ThoughtParticle
