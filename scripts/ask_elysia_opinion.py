...
# 1. 프랙탈 목표 분해 사용
try:
    from Core.Intelligence.fractal_quaternion_goal_system import FractalGoalDecomposer
...
# 2. 분산 의식 - 원탁 회의 사용
try:
    from Core.Intelligence.collective_intelligence_system import CollectiveIntelligence
