...
def fix_imports():
    ...
    replacements = [
        # Education remapping
        (r'from Core\.Education', 'from Core.Intelligence.Education'),
        
        # Soul remapping
        (r'from Core\.Soul', 'from Core.World.Soul'),
        
        # Evolution remapping
        (r'from Core\.Evolution', 'from Core.World.Evolution'),
        
        # Autonomy remapping
        (r'from Core\.Autonomy', 'from Core.World.Autonomy'),
        
        # Intelligence remapping
        (r'from Core\.Knowledge', 'from Core.Intelligence.Knowledge'),
        (r'from Core\.Memory', 'from Core.Intelligence.Memory'),
        ...
        (r'from Core\.Orchestra', 'from Core.Governance.Orchestra'),
        (r'from Core\.Orchestration', 'from Core.Governance.Orchestration'),
        (r'from Core\.Security', 'from Core.Governance.Security'),
        (r'from Core\.Interface', 'from Core.Governance.Interface'),
        (r'from Core\.Interaction', 'from Core.Governance.Interaction'),
