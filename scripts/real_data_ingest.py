...
class RealDataIngester:
    ...
    def __init__(self):
        ...
        try:
            from Core.01_Foundation.05_Foundation_Base.Foundation.concept_extractor import ConceptExtractor
        ...
        try:
            from Core.02_Intelligence.01_Reasoning.Intelligence.concept_digester import ConceptDigester
