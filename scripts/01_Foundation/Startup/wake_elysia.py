...
from Core.03_Interaction.01_Interface.Interface.world_exporter import get_world_exporter
from Core.01_Foundation.01_Core_Logic.Elysia.elysia_core import ElysiaCore # [NEW] Unified Brain
...
def wake_elysia():
    ...
    if not loaded and graph.pos_tensor.shape[0] < 5:
        ...
        from Core.01_Foundation.05_Foundation_Base.Foundation.knowledge_migrator import get_migrator
    ...
    # [NEW] HUD
    from Core.03_Interaction.01_Interface.Interface.console_hud import get_console_hud
    ...
    try:
        while True:
            ...
            if cycle_count % 30 == 0:
                 ...
                 from Core.04_Evolution.01_Growth.Autonomy.wave_coder import get_wave_coder
            ...
            if cycle_count % 25 == 0:
                 ...
                 from Core.04_Evolution.01_Growth.Autonomy.structure_cannibal import get_structure_cannibal
