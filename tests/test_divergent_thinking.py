...
from Core.IntelligenceLayer.Cognition.thought_space import ThoughtSpace, ThoughtShape
...
from Core.IntelligenceLayer.Cognition.thought_space import ThoughtParticle
import hashlib
