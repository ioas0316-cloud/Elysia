...
def test_free_will():
    ...
    try:
        from Core._02_Intelligence._01_Reasoning.Intelligence.Intelligence.Will.free_will_engine import FreeWillEngine, MissionType
...
def test_recursive_planning():
    ...
    try:
        from Core._02_Intelligence._01_Reasoning.Intelligence.Intelligence.executive_function import RecursivePlanner
