...
def main():
    ...
    # 1. 자율 개선 엔진 초기화
    print("🔧 자율 개선 엔진 초기화...")
    from Core._04_Evolution._01_Growth.Evolution.Evolution.autonomous_improver import AutonomousImprover, ImprovementType
    from Core._04_Evolution._01_Growth.Evolution.Evolution.auto_fix_system import AutoFixSystem
