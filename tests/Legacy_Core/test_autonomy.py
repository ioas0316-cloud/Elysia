...
from Core._01_Foundation.01_Core_Logic.Elysia.Elysia import Elysia
from Core._04_Evolution._01_Growth.Evolution.Evolution.Life.heart import ImpulseType
