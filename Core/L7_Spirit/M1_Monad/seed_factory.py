...
==============================
Core.L7_Spirit.M1_Monad.seed_factory
...
from Core.L7_Spirit.M1_Monad.principles import ThermodynamicsRule, FluidDynamicsRule, OpticsRule, SemanticsRule, LinguisticsRule, SociologyRule
