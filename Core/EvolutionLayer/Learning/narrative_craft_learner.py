...
# 기존 시스템 임포트
try:
    from Core.FoundationLayer.Philosophy.why_engine import WhyEngine, PrincipleExtraction
    HAS_WHY_ENGINE = True
except ImportError:
    HAS_WHY_ENGINE = False

try:
    from Core.FoundationLayer.Foundation.dual_layer_personality import DualLayerPersonality, ExperientialAspect
