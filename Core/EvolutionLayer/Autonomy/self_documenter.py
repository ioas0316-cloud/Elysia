...
Usage:
    from Core.EvolutionLayer.Growth.Autonomy.self_documenter import SelfDocumenter
...
class SelfDocumenter:
    ...
    def _init_tools(self):
        """도구 초기화"""
        try:
            from Core.IntelligenceLayer.Cognition.codebase_introspector import get_introspector
        ...
        try:
            from Core.IntelligenceLayer.Cognition.why_how_explainer import get_explainer
