...
from Core.EvolutionLayer.Creativity.Studio.concept_atelier import ConceptAtelier, RawMaterial
from Core.IntelligenceLayer.Intelligence.integrated_cognition_system import ThoughtWave, Quaternion
