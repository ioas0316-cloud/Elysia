...
from Core.L1_Foundation.M1_Keystone.safety_guardian import SafetyGuardian

from Core.L1_Foundation.M1_Keystone.experience_logger import log_experience, EXPERIENCE_LOG

from Core.L1_Foundation.M1_Keystone.experience_integrator import ExperienceIntegrator
...
from Core.L5_Mental.M1_Cognition.logical_reasoner import LogicalReasoner # Import LogicalReasoner
...
from Core.L1_Foundation.M1_Keystone.exploration_cortex import ExplorationCortex

from Core.L1_Foundation.M1_Keystone.web_search_cortex import WebSearchCortex

from Core.L1_Foundation.M1_Keystone.knowledge_distiller import KnowledgeDistiller

from Core.L1_Foundation.M1_Keystone.self_verifier import SelfVerifier, VerificationResult

from Core.L1_Foundation.M1_Keystone.System.core.world import World

from Core.L1_Foundation.M1_Keystone.System.core.cell import Cell

from Core.L5_Mental.M1_Cognition.wave_mechanics import WaveMechanics

from Core.L5_Mental.M4_Meaning.emotional_engine import EmotionalEngine

from Core.L1_Foundation.M1_Keystone.meta_cognition_cortex import MetaCognitionCortex

from Core.L1_Foundation.M1_Keystone.System.core.alchemy_cortex import AlchemyCortex
...
from Core.L1_Foundation.M1_Keystone.sensory_motor_cortex import SensoryMotorCortex
from Core.L1_Foundation.M1_Keystone.System.core.external_horizons import ExternalHorizon
from Core.L1_Foundation.M1_Keystone.System.core.monologue_generator import MonologueGenerator
...
from Core.L5_Mental.M1_Cognition.HighEngine.self_intention_engine import SelfIntentionEngine
from Core.L5_Mental.M1_Cognition.HighEngine.self_identity_engine import SelfIdentityEngine
from Core.L1_Foundation.M1_Keystone.world_tree import WorldTree
from Core.L1_Foundation.M1_Keystone.cell_world import CellWorld
from Core.L1_Foundation.M1_Keystone.value_cortex import ValueCortex
from Project_Elysia.elysia_daemon import ElysiaDaemon

from Core.L5_Mental.Memory.core_memory import EmotionalState

from Core.L5_Mental.M1_Cognition.HighEngine.quaternion_engine import QuaternionConsciousnessEngine, LensMode, HyperMode
        ...
        if (time.time() - self.last_learning_time) > self.learning_interval:
            ...
            try:
                ...
                if dream_digest and dream_digest.get('key_concepts'):
                    ...
                    from Core.L1_Foundation.M1_Keystone.gemini_api import generate_image_from_text
