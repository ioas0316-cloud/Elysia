...
Usage:
    ...
    #        
    from Core.L5_Mental.M1_Cognition.Physics_Waves.Wave.quality_guard import WaveQualityGuard
...
#    
try:
    from Core.L5_Mental.M1_Cognition.Intelligence.wave_coding_system import get_wave_coding_system, CodeWave
    WAVE_AVAILABLE = True
except ImportError:
