...
try:
    from Core.L5_Mental.M1_Cognition.Logos.gap_analyzer import Principle
    from Core.L5_Mental.M1_Cognition.Logos.WaveLinguistics.gravitational_linguistics import GravitationalLinguistics, WordBody
