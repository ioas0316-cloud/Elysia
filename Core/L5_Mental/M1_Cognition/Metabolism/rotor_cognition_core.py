...
========================================================
Core.L5_Mental.M1_Cognition.Metabolism.rotor_cognition_core
...
from Core.L5_Mental.M1_Cognition.Metabolism.holographic_council import HolographicCouncil, DebateResult
            ...
            if isinstance(psionic_result, dict):
                ...
                if confidence < 0.4 and potential > 0.5:
                    ...
                    try:
                        ...
                        from Core.L1_Foundation.M1_Keystone.yggdrasil import yggdrasil as ygg
