...
class Blueprint:
    ...
    structure: Dict[str, str] # {module_name: action} (e.g., 'Core.L1_Foundation.M1_Keystone': 'Keep')
...
class EvolutionArchitect:
    ...
    def __init__(self, cns_ref=None):
        ...
        try:
            from Core.L4_Causality.M3_Mirror.Evolution.Growth.Autonomy.self_modifier_v2 import get_self_modifier
    ...
    def design_seed(self, intent: str = "Wisdom") -> Blueprint:
        ...
        if gaps:
            ...
            structure["Core.L5_Mental.M1_Cognition"] = "Harmonize (Link patterns)"
