...
from Core.L1_Foundation.Foundation.safety_guardian import SafetyGuardian

from Core.L1_Foundation.Foundation.experience_logger import log_experience, EXPERIENCE_LOG
...
from Core.L1_Foundation.Foundation.exploration_cortex import ExplorationCortex

from Core.L1_Foundation.Foundation.web_search_cortex import WebSearchCortex

from Core.L1_Foundation.Foundation.knowledge_distiller import KnowledgeDistiller

from Core.L1_Foundation.Foundation.self_verifier import SelfVerifier, VerificationResult
...
from Core.L1_Foundation.Foundation.System.core.alchemy_cortex import AlchemyCortex
...
from Core.L1_Foundation.Foundation.System.core.external_horizons import ExternalHorizon
from Core.L1_Foundation.Foundation.System.core.monologue_generator import MonologueGenerator
...
from Core.L5_Mental.Reasoning_Core.HighEngine.self_intention_engine import SelfIntentionEngine
from Core.L5_Mental.Reasoning_Core.HighEngine.self_identity_engine import SelfIdentityEngine
...
from Core.L5_Mental.Reasoning_Core.HighEngine.quaternion_engine import QuaternionConsciousnessEngine, LensMode, HyperMode
        ...
        if (time.time() - self.last_learning_time) > self.learning_interval:
            ...
            try:
                ...
                if dream_digest and dream_digest.get('key_concepts'):
                    ...
                    from Core.L1_Foundation.Foundation.gemini_api import generate_image_from_text
