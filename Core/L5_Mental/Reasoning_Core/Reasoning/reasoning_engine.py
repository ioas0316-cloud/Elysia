...
from Core.L5_Mental.Reasoning_Core.Reasoning.perspective_simulator import PerspectiveSimulator



from Core.L5_Mental.Reasoning_Core.Reasoning.latent_causality import LatentCausality

from Core.L5_Mental.Reasoning_Core.Reasoning.purpose_field import PurposeField, ValueCoordinate

from Core.L5_Mental.Reasoning_Core.Topography.mental_terrain import MentalTerrain, Vector2D
...
from Core.L5_Mental.Reasoning_Core.Reasoning.paradox_engine import ParadoxEngine, ResolutionStrategy
...
from Core.L5_Mental.Reasoning_Core.Metabolism.crystallizer import Crystallizer
...
class ReasoningEngine:
    ...
    def __init__(self, index_path: str = "data/Weights/DeepSeek-Coder-V2-Lite-Instruct/model.safetensors.index.json"):
        ...
        from Core.L5_Mental.Reasoning_Core.Brain.sovereign_vocalizer import SovereignCortex

        self.cortex = SovereignCortex()

        

        from Core.L5_Mental.Reasoning_Core.Discovery.scholar_pulse import ScholarPulse

        self.scholar = ScholarPulse(self) # [NEW] The Scholar Organ

        

        from Core.L5_Mental.Reasoning_Core.Reasoning.fractal_deconstructor import FractalDeconstructor
        ...
        from Core.L5_Mental.Reasoning_Core.Reasoning.memetic_legacy import AkashicField
