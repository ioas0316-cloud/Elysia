...
Usage:
    from Core.L5_Mental.Reasoning_Core.Physics_Waves.Wave import (
        analyze_code,
        detect_resonance,
        compress_to_dna,
        decompress_from_dna
...
#           
try:
    from Core.L5_Mental.Reasoning_Core.Intelligence.wave_coding_system import (
...
#            
try:
    from Core.L5_Mental.Reasoning_Core.Physics_Waves.Wave.quality_guard import WaveQualityGuard, QualityReport
