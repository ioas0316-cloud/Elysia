...
from Core.L5_Mental.Reasoning_Core.Intelligence.tool_discovery import ToolDiscoveryProtocol
...
class ReasoningEngine:
    ...
    def __init__(self):
        ...
        from Core.L6_Structure.Engine.Governance.Interaction.Interface.dialogue_interface import DialogueInterface
