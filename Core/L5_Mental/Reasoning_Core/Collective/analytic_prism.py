...
from Core.L5_Mental.Reasoning_Core.Collective.resonant_cell import ResonantCell
from Core.L1_Foundation.Foundation.universal_constants import AXIOM_WISDOM, AXIOM_SIMPLICITY
