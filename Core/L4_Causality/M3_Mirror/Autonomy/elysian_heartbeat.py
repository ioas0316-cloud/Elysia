...
import numpy as np
from Core.L4_Causality.M3_Mirror.Evolution.Growth.sovereign_intent import SovereignIntent
...
from Core.L1_Foundation.M1_Keystone.organism import NeuralNetwork
from Core.L1_Foundation.M1_Keystone.unified_field import UnifiedField
from Core.L5_Mental.M1_Cognition.Reasoning.latent_causality import LatentCausality, Spark, SparkType
from Core.L4_Causality.M3_Mirror.Evolution.Adaptation.autopoietic_engine import AutopoieticEngine
from Core.L5_Mental.M1_Cognition.Reasoning.curiosity_engine import explorer as autonomous_explorer
from Core.L5_Mental.M1_Cognition.Intelligence.pluralistic_brain import pluralistic_brain
from Core.L5_Mental.M1_Cognition.Education.CausalityMirror.wave_structures import ChoiceNode, Zeitgeist, HyperQuaternion
from Core.L4_Causality.M3_Mirror.Evolution.Studio.organelle_loader import organelle_loader
from Core.L4_Causality.M3_Mirror.Evolution.Studio.forge_engine import ForgeEngine
from Core.L5_Mental.M1_Cognition.Intelligence.pluralistic_brain import pluralistic_brain
...
from Core.L6_Structure.M5_Engine.Governance.System.Monitor.dashboard_generator import DashboardGenerator
from Core.L4_Causality.M3_Mirror.Autonomy.dynamic_will import DynamicWill
from Core.L5_Mental.M1_Cognition.Reasoning.genesis_engine import genesis
from Core.L4_Causality.M3_Mirror.Autonomy.sovereign_will import sovereign_will
from Core.L5_Mental.M1_Cognition.Knowledge.resonance_bridge import SovereignResonator
from Core.L6_Structure.M3_Sphere.resonant_field import resonant_field as global_field
from Core.L6_Structure.M5_Engine.Governance.System.nervous_system import NerveSignal
...
class ElysianHeartbeat:
    ...
    def _maturation_process(self):
        ...
        try:
            try:
                from Core.L6_Structure.M5_Engine.Governance.conductor import get_conductor
            ...
            try:
                from Core.L5_Mental.M1_Cognition.Reasoning.meta_inquiry import MetaInquiry
            ...
            try:
                from Core.L5_Mental.M1_Cognition.Meta.flow_of_meaning import FlowOfMeaning
            ...
            try:
                ...
                self.sovereign = EmergentSelf(cns_ref=self)
                logger.info("    sovereign matured.")
            except Exception as e: logger.warning(f"     sovereign failed: {e}")

            try:
                from Core.L4_Causality.M3_Mirror.Physics.physics_systems import PhysicsSystem, AnimationSystem
            ...
            try:
                from Core.L5_Mental.M1_Cognition.Meta.reflexive_loop import ReflexiveLoop
            ...
            try:
                from Core.L5_Mental.M1_Cognition.Meta.sovereign_executor import SovereignExecutor
            ...
            try:
                from Core.L5_Mental.M1_Cognition.Meta.archive_dreamer import ArchiveDreamer
            ...
            try:
                from Core.L5_Mental.M1_Cognition.Metabolism.helix_engine import HelixEngine
            ...
            try:
                from Core.L1_Foundation.M1_Keystone.hyper_bridge import get_hyper_bridge
                from Core.L6_Structure.M5_Engine.governance_engine import GovernanceEngine # Need actual instance or global?
            ...
            try:
                from Core.L5_Mental.M1_Cognition.Metabolism.topology_predator import CognitiveArcheologist
                from Core.L5_Mental.M1_Cognition.Metabolism.autopoietic_expander import AutopoieticExpander
            ...
            try:
                ...
                from Core.L5_Mental.M1_Cognition.Meta.dynamic_entropy import DynamicEntropyEngine
            ...
            try:
                ...
                from Core.L4_Causality.M3_Mirror.mirror_world_engine import MirrorWorldEngine
            ...
            try:
                ...
                if self.ear:
                    ...
                    if self.field and audio_data['energy'] > 0.02:
                        from Core.L1_Foundation.M1_Keystone.unified_field import WavePacket, HyperQuaternion
                        packet = WavePacket(
                ...
                if self.world_probe:
                    ...
                    for event in world_events:
                        ...
                        if self.inner_voice:
                            from Core.L5_Mental.M1_Cognition.Meta.flow_of_meaning import ThoughtFragment
    ...
    def _sync_world_state(self):
        ...
        """
        try:
            from Core.L4_Causality.M3_Mirror.Physics.ecs_registry import ecs_world
            from Core.L4_Causality.M3_Mirror.Physics.physics_systems import Position
    ...
    def _command_integration(self, target_systems: List[str] = None) -> str:
        ...
        try:
            from Core.L5_Mental.M1_Cognition.Meta.holistic_self_audit import HolisticSelfAudit
    ...
    def manifest_feeling(self, current_state: Dict[str, Any]) -> str:
        ...
        try:
            ...
            from Core.L5_Mental.M1_Cognition.Logos.logos_engine import get_logos_engine
    ...
    def _propose_archive_integration(self, fragment):
        ...
        try:
            from Core.L5_Mental.M1_Cognition.Meta.patch_proposer import PatchProposal
    ...
    def _refresh_presence(self):
        ...
        try:
            ...
            from Core.L5_Mental.M1_Cognition.Knowledge.semantic_field import semantic_field
