...
from Core.Foundation.Foundation.fractal_concept import ConceptNode, ConceptDecomposer
...
from Core.Foundation.Foundation.grammar_engine import GrammarEmergenceEngine
