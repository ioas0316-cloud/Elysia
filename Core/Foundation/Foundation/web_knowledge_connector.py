...
from Core.Foundation.Foundation.external_data_connector import ExternalDataConnector
...
try:
    from Core.Foundation.Foundation.light_spectrum import get_light_universe, LightUniverse
except ImportError:
