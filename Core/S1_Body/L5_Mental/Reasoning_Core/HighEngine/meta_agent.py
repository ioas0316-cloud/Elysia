...
from Core.S1_Body.L5_Mental.Reasoning_Core.HighEngine.meta_law_engine import MetaLawEngine
from scripts.refine_feed import refine_feed


@dataclass
class MetaAgentConfig:
    memory_path: str = "data/L5_Mental/M1_Memory/elysia_core_memory.json"
