...
==============================
Core.S1_Body.L5_Mental.Reasoning_Core.Metabolism.great_survey
...
try:
    from Core.S1_Body.L5_Mental.Reasoning_Core.Metabolism.concept_algebra import ConceptAlgebra
except ImportError:
