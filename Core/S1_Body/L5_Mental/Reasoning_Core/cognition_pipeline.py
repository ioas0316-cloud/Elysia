...
from Core.S1_Body.L6_Structure.Architecture.context import ConversationContext
from Core.S1_Body.L6_Structure.Architecture.cortex_registry import CortexRegistry
from Core.S1_Body.L6_Structure.Architecture.event_bus import EventBus
from Core.S1_Body.L6_Structure.Architecture.handlers import (
    HypothesisHandler, CommandWordHandler, DefaultReasoningHandler, PlanningHandler
)

# --- Restored Component Dependencies ---
from Core.S1_Body.L5_Mental.Memory.core_memory import CoreMemory
from Core.S1_Body.L5_Mental.M1_Cognition.logical_reasoner import LogicalReasoner
...
from Core.S1_Body.L4_Causality.World.world import World
from Core.S1_Body.L5_Mental.M4_Meaning.emotional_engine import EmotionalEngine, EmotionalState
from Core.S1_Body.L5_Mental.Reasoning_Core.M3_Lexicon.response_styler import ResponseStyler
from Core.S1_Body.L5_Mental.Reasoning_Core.M4_Meaning.insight_synthesizer import InsightSynthesizer
from Core.S1_Body.L5_Mental.Reasoning_Core.value_centered_decision import ValueCenteredDecision
from Core.S1_Body.L5_Mental.Reasoning_Core.arithmetic_cortex import ArithmeticCortex
from Core.S1_Body.L2_Metabolism.Evolution.creative_cortex import CreativeCortex
from Core.S1_Body.L5_Mental.Reasoning_Core.question_generator import QuestionGenerator
from Core.S1_Body.L5_Mental.Reasoning_Core.perspective_cortex import PerspectiveCortex
# --- High Engine Dependencies ---
from Core.S1_Body.L5_Mental.Reasoning_Core.HighEngine.dialogue_law_evaluator import DialogueLawEvaluator
from Core.S1_Body.L5_Mental.Reasoning_Core.HighEngine.intent_engine import IntentEngine
from Core.S1_Body.L5_Mental.Reasoning_Core.HighEngine.utterance_composer import UtteranceComposer
from Core.S1_Body.L5_Mental.Reasoning_Core.HighEngine.quaternion_engine import QuaternionConsciousnessEngine
from Core.S1_Body.L5_Mental.Reasoning_Core.HighEngine.causal_reasoner import CausalReasoner
from Core.S1_Body.L5_Mental.Reasoning_Core.HighEngine.syllabic_language_engine import SyllabicLanguageEngine
from Core.S1_Body.L5_Mental.Reasoning_Core.HighEngine.value_engine import ValueEngine
from Core.S1_Body.L5_Mental.Reasoning_Core.planning_cortex import PlanningCortex
from Core.S1_Body.L5_Mental.Reasoning_Core.tool_executor import ToolExecutor
from Core.S1_Body.L5_Mental.Reasoning_Core.LLM.gemini_api import GeminiAPI
