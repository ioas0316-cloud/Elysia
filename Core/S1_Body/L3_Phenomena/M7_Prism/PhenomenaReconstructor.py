...
=======================================================
Core.S1_Body.L3_Phenomena.M7_Prism.PhenomenaReconstructor
...
try:
    ...
    from Core.S1_Body.L1_Foundation.Foundation.Heaven.TrinarySwitch import TrinaryState, TrinarySwitch
except ImportError:
    import sys
    import os
