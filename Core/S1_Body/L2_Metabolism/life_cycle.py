...
try:
    from Core.S1_Body.L1_Foundation.Foundation.self_governance import SelfGovernance, IdealSelf
except ImportError:
    SelfGovernance = None
    IdealSelf = None
...
try:
    from Core.S1_Body.L5_Mental.Reasoning_Core.Reasoning.causal_geometry import TensionField
except ImportError:
    TensionField = None
...
try:
    from Core.S1_Body.L5_Mental.Reasoning_Core.predictive_mind import PredictiveMind
except ImportError:
    PredictiveMind = None
