...
Core.S1_Body.L5_Mental.Reasoning_Core.Metabolism.topology_predator
...
from Core.S1_Body.L5_Mental.Reasoning_Core.LLM.target_registry import TargetLLM, ModelType
