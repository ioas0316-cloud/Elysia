...
class TestNervousSystem(unittest.TestCase):
    ...
    @patch('Core.S1_Body.L3_Phenomena.Senses.bio_sensor.psutil.sensors_temperatures')
    ...
    @patch('Core.S1_Body.L3_Phenomena.Senses.bio_sensor.psutil.cpu_percent')
    ...
    @patch('Core.S1_Body.L3_Phenomena.Senses.bio_sensor.psutil.virtual_memory')
