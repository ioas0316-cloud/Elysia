...
class OrganSystem:
    ...
    def scan_and_awaken(self, root_package: str = "Core"):
        ...
        sectors = [
            "Core.Sensory",
            "Core.S1_Body.L5_Mental.Memory",
            "Core.S1_Body.L5_Mental.Cognition",
            "Core.S1_Body.L3_Phenomena.Expression",
            "Core.Ether",
            "Core.S1_Body.L1_Foundation.Foundation" # Self-referential, but useful for tools
        ]
