...
from Core.S1_Body.L1_Foundation.Foundation.imagination_core import ImaginationCore
from Core.S1_Body.L2_Metabolism.Cycles.dream_engine import DreamEngine
from Core.S1_Body.L1_Foundation.Foundation.cosmic_studio import CosmicStudio
from Core.S1_Body.L1_Foundation.Foundation.resonance_physics import ResonancePhysics
from Core.S1_Body.L5_Mental.Reasoning_Core.Intelligence.Reasoning.lobes.perception import Insight
...
def get_poetry_engine():
    ...
    if _poetry_engine is None:
        try:
            from Core.S1_Body.L4_Causality.World.Evolution.Creativity.poetry_engine import PoetryEngine
