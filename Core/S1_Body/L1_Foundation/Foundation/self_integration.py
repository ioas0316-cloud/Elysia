...
from Core.S1_Body.L1_Foundation.Foundation.fractal_kernel import FractalKernel
from Core.S1_Body.L1_Foundation.Foundation.autonomous_fractal_learning import FractalLearner
from Core.S1_Body.L1_Foundation.Foundation.wave_memory import WaveMemory
...
class ElysiaIntegrator:
    ...
    def _get_registry(self):
        ...
        if self.registry is None:
            try:
                from Core.S1_Body.L1_Foundation.Foundation.System.system_registry import get_system_registry
