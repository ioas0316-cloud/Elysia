...
from Core.S1_Body.L1_Foundation.Foundation.Physics.soul_physics import get_soul_physics, InputParticle, WavePacket, SoulLayer, TrajectoryResult, SpectralResult
from Core.S1_Body.L1_Foundation.Foundation.Physics.universal_scope import get_universal_scope, CosmicPerspective
from Core.S1_Body.L6_Structure.Wave.text_wave_converter import get_text_wave_converter
from Core.S1_Body.L1_Foundation.Foundation.universal_constants import ENTROPY_WEIGHT_FACTOR, ABYSSAL_THRESHOLD
