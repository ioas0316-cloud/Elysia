...
from Core.S1_Body.L1_Foundation.Foundation.external_data_connector import ExternalDataConnector
from Core.S1_Body.L1_Foundation.Foundation.internal_universe import InternalUniverse

# Problem-solving learning imports
try:
    from Core.S1_Body.L5_Mental.Reasoning_Core.Cognition.principle_distiller import PrincipleDistiller
...
try:
    from Core.S1_Body.L6_Structure.Wave.light_spectrum import get_light_universe, LightUniverse
except ImportError:
