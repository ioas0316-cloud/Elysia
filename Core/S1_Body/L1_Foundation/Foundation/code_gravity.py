...
from Core.S1_Body.L1_Foundation.Foundation.potential_field import PotentialField
    ...
    def scan_galaxy(self):
        ...
        for path, data in self.nodes.items():
            ...
            for imp in data["imports"]:
                ...
                # Import "Core.S1_Body.L1_Foundation.Physics" -> "Core\Physics\__init__.py" or "Core\Physics.py"
