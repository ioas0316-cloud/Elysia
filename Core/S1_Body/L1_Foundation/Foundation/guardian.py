...
from Legacy.Project_Sophia.safety_guardian import SafetyGuardian

from Legacy.Project_Sophia.experience_logger import log_experience, EXPERIENCE_LOG

from Legacy.Project_Sophia.experience_integrator import ExperienceIntegrator

from Legacy.Project_Sophia.self_awareness_core import SelfAwarenessCore

from memory_weaver import MemoryWeaver

from Core.S1_Body.L5_Mental.Memory.core_memory import CoreMemory, Memory
...
from Legacy.Project_Sophia.exploration_cortex import ExplorationCortex

from Legacy.Project_Sophia.web_search_cortex import WebSearchCortex

from Legacy.Project_Sophia.knowledge_distiller import KnowledgeDistiller

from Legacy.Project_Sophia.self_verifier import SelfVerifier, VerificationResult
...
from alchemy_cortex import AlchemyCortex

from creative_expression import CreativeExpression
from external_sensory_cortex import ExternalSensoryCortex
from sensory_cortex import SensoryCortex
from Legacy.Project_Sophia.sensory_motor_cortex import SensoryMotorCortex
from external_horizons import ExternalHorizon
from monologue_generator import MonologueGenerator
from manifestation_cortex import ManifestationCortex
from dream_observer import DreamObserver
from core.cell_memory_store import CellMemoryStore
from high_engine.self_intention_engine import SelfIntentionEngine
from high_engine.self_identity_engine import SelfIdentityEngine
from Legacy.Project_Sophia.world_tree import WorldTree
from Legacy.Project_Sophia.cell_world import CellWorld
        ...
        if (time.time() - self.last_learning_time) > self.learning_interval:
            ...
            try:
                ...
                if dream_digest and dream_digest.get('key_concepts'):
                    ...
                    from Legacy.Project_Sophia.gemini_api import generate_image_from_text
