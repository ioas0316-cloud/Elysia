...
class StructuralUnifier:
    ...
    def scan_resonance(self) -> Dict[str, Any]:
        ...
        from Core.S1_Body.L6_Structure.Wave.resonance_field import ResonanceField, PillarType
        ...
        for source, target in connections:
            ...
            if target in field.nodes:
                ...
                # Try to find partial match (e.g. Core.S1_Body.L1_Foundation.Foundation -> Foundation)
                parts = target.split('.')
