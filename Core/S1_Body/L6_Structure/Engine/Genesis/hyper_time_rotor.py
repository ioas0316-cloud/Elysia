...
from Core.S1_Body.L6_Structure.Engine.Genesis.universal_rotor import UniversalRotor # Type hinting
...
class HyperTimeRotor:
    ...
    def set_era(self, era_name: str):
        ...
        if era_name == "SILICON":
            from Core.S1_Body.L6_Structure.Engine.Genesis.silicon_hardware_laws import law_nand_logic, law_clock_pulse
            ...
            from Core.S1_Body.L6_Structure.Engine.Genesis.silicon_hardware_laws import law_alu_add
