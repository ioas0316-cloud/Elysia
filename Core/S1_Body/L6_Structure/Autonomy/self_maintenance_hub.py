...
#          
try:
    from Core.S1_Body.L1_Foundation.Foundation.self_reflector import SelfReflector, CodeMetrics
    HAS_REFLECTOR = True
...
try:
    from Core.S1_Body.L1_Foundation.Foundation.self_modification import (
