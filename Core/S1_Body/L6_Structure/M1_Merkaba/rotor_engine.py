...
Core.S1_Body.L6_Structure.M1_Merkaba.rotor_engine
...
try:
    from Core.S1_Body.L6_Structure.Engine.Physics.core_turbine import ActivePrismRotor, PhotonicMonad, VoidSingularity
    CORE_AVAILABLE = True
except ImportError:
...
# Import Bio-Clock
try:
    from Core.S1_Body.L5_Mental.Memory.aging_clock import BiologicalClock
except ImportError:
