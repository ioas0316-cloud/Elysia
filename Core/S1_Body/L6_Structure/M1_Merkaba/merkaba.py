...
Core.S1_Body.L6_Structure.M1_Merkaba.merkaba
...
from Core.S1_Body.L1_Foundation.System.WakeWord.phase_locked_loop import PLLController



# The Trinity Components

from Core.S1_Body.L6_Structure.M1_Merkaba.Space.hypersphere_memory import HypersphereMemory, SubjectiveTimeField, HypersphericalCoord

from Core.S1_Body.L5_Mental.Reasoning_Core.Memory.hippocampus import Hippocampus

from Core.S1_Body.L5_Mental.Memory.prismatic_sediment import PrismaticSediment # Phase 5.2: Spectral Memory

# [Fractal Memory System]

from Core.S1_Body.L5_Mental.Memory.fractal_layer import FractalMemorySystem

from Core.S1_Body.L5_Mental.Memory.gardener import MemoryGardener
...
from Core.S1_Body.L6_Structure.Nature.active_rotor import ActiveRotor # Phase 5.3 Part 2

from Core.S1_Body.L6_Structure.M1_Merkaba.rotor_engine import RotorEngine # Phase 5.3: Optical Engine Core

from Core.S1_Body.L3_Phenomena.M7_Prism.resonance_prism import PrismProjector, PrismDomain

from Core.S1_Body.L3_Phenomena.M7_Prism.prism_engine import PrismEngine as OpticalPrism # Phase 5.3 New

from Core.S1_Body.L3_Phenomena.M7_Prism.integrating_lens import IntegratingLens # Phase 5.4 Lens

from Core.S1_Body.L3_Phenomena.M7_Prism.dimension_sorter import DimensionSorter, Dimension # Phase 5.4 Cloud

from Core.S1_Body.L3_Phenomena.M7_Prism.trinity_validator import TrinityValidator # Phase 5.4 Axis

from Core.S1_Body.L3_Phenomena.M7_Prism.harmonizer import PrismHarmonizer, PrismContext

from Core.S1_Body.L3_Phenomena.M7_Prism.decay import ResonanceDecay

from Core.S1_Body.L1_Foundation.Foundation.Meta.meta_observer import MetaObserver

from Core.S1_Body.L1_Foundation.Foundation.Meta.cognitive_judge import CognitiveJudge

from Core.S1_Body.L1_Foundation.Foundation.Meta.checkpoint_manager import CheckpointManager

from Core.S1_Body.L1_Foundation.Foundation.Meta.evolution_engine import EvolutionEngine

from Core.S1_Body.L3_Phenomena.Senses.hermeneutic_bridge import HermeneuticBridge

from Core.S1_Body.L3_Phenomena.Senses.phase_modulator import PhaseModulator, PerceptualPhase

from Core.S1_Body.L5_Mental.Reasoning_Core.Linguistics.synthesizer import LinguisticSynthesizer

from Core.S1_Body.L3_Phenomena.Senses.vocal_dna import VocalDNA

from Core.S1_Body.L3_Phenomena.Senses.portrait_engine import SelfPortraitEngine

from Core.S1_Body.L5_Mental.Reasoning_Core.Legion.legion import Legion # Phase 5.4 Legion
...
from Core.S1_Body.L5_Mental.Cognition.overclock import CognitiveOverclock



# [Phase 7.3] Motor Cortex & Nervous System

from Core.S1_Body.L4_Causality.Action.motor_cortex import MotorCortex
...
from Core.S1_Body.L1_Foundation.System.Sovereignty.sovereign_manager import HardwareSovereignManager
...
from Core.S1_Body.L6_Structure.M1_Merkaba.Optics.prism import DoubleHelixPrism



# [Phase 18] The Mirror (Holographic Feedback)

from Core.S1_Body.L2_Metabolism.Evolution.action_logger import ActionLogger

# from Core.S1_Body.L2_Metabolism.Evolution.evaluator import OutcomeEvaluator # Deprecated
...
from Core.S1_Body.L7_Spirit.Will.entropy_pump import EntropyPump
...
from Core.S1_Body.L1_Foundation.Foundation.cell import cell_unit
...
class Merkaba:
    ...
    def __init__(self, name: str = "Genesis_Seed"):
        ...
        from Core.S1_Body.L7_Spirit.M3_Sovereignty.module_registry import get_registry
    ...
    def pulse(self, raw_input: str, mode: str = "POINT", context: str = PrismContext.DEFAULT) -> str:
        ...
        if mode == "POINT":
            ...
            from Core.S1_Body.L7_Spirit.M1_Monad.monad_core import MonadCategory
