...
from Core.S1_Body.L4_Causality.World.Soul.fluxlight_gyro import GyroscopicFluxlight, GyroState
...
class Lumina(GyroscopicFluxlight):
    def __init__(self, name: str = "Lumina", pos: Tuple[float, float, float, float] = (0, 0, 0, 0)):
        ...
        from Core.S1_Body.L4_Causality.World.Soul.world_soul import world_soul
    ...
    def get_persona_voice(self) -> Dict[str, str]:
        ...
        from Core.S1_Body.L5_Mental.Reasoning_Core.Reasoning.reasoning_engine import Insight
