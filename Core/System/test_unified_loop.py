...
sys.modules["Core.Phenomena.visual_cortex"] = mock_visual_mod
...
sys.modules["Core.Phenomena.voicebox"] = mock_voice_mod
...
sys.modules["Core.Phenomena.synesthesia_engine"] = mock_syn_mod
