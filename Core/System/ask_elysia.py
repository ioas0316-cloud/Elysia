...
from Core.System.transcendence_engine import TranscendenceEngine
from Core.System.knowledge_acquisition import KnowledgeAcquisitionSystem
...
class ElysiaConversation:
    ...
    def inception(self, desire: str, goal: str):
        ...
        from Core.System.free_will_engine import Intent
        import time
