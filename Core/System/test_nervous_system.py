...
from Core.Phenomena.bio_sensor import BioSensor
...
class TestNervousSystem(unittest.TestCase):
    ...
    @patch('Core.Phenomena.bio_sensor.psutil.sensors_temperatures')
    ...
    @patch('Core.Phenomena.bio_sensor.psutil.cpu_percent')
    ...
    @patch('Core.Phenomena.bio_sensor.psutil.virtual_memory')
