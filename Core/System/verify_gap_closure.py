...
from Core.System.hardware_monitor import BioSignal
from Core.Cognition.rotor_cognition_core import RotorCognitionCore
from Core.Cognition.emergent_language import EmergentLanguageEngine, ProtoSymbol, SymbolType
...
def test_void_tether():
    ...
    try:
        from Core.Cognition.rotor_cognition_core import ActiveVoid
        void = ActiveVoid()
