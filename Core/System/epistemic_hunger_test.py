...
from Core.System.causal_narrative_engine import ThoughtUniverse
from Core.System.gap_bridging import GapBridgingDrive
from Core.System.metacognition import GapReport
...
def run_hunger_demo():
    ...
    if True: # Using local ThoughtUniverse
        ...
        from Core.System.metacognition import CognitiveMetrics
        report = GapReport(
