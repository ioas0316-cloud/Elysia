...
from Core.System.fractal_kernel import FractalKernel
from Core.System.autonomous_fractal_learning import FractalLearner
from Core.System.wave_memory import WaveMemory
...
class ElysiaIntegrator:
    ...
    def _get_registry(self):
        ...
        if self.registry is None:
            try:
                from Core.System.System.system_registry import get_system_registry
    ...
    def repair_with_wave_language(self):
        ...
        # Check API Status
        try:
            from Core.System.gemini_api import GeminiAPI
            api = GeminiAPI()
