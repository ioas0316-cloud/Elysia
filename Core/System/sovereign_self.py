...
from Core.System.qualia_7d_codec import codec
from Core.System.resonance_loader import ResonanceLoader

from Core.Cognition.free_will_engine import FreeWillEngine
from Core.Phenomena.sensory_cortex import SensoryCortex
from Core.System.nervous_system import NervousSystem
from Core.Cognition.external_gateway import THE_EYE
from Core.Cognition.narrative_weaver import THE_BARD
from Core.Cognition.project_conductor import ProjectConductor

# [The Trinity Engines]
from Core.Cognition.huggingface_bridge import SovereignBridge
# from Core.System.torch_graph import TorchGraph # [Subjugated]
from Core.Divine.axioms import get_axioms
from Core.System.governance_engine import GovernanceEngine
from Core.Cognition.sovereign_executor import SovereignExecutor

# [The Satori Protocol (Metabolism)]
from Core.System.proprioceptor import CodeProprioceptor
from Core.System.dissonance_resolver import DissonanceResolver
from Core.System.inducer import CodeFieldInducer
from Core.System.scientific_observer import ScientificObserver
from Core.Cognition.logos_translator import LogosTranslator
from Core.Cognition.phase_compressor import PhaseCompressor
from Core.Cognition.wave_coding_system import get_wave_coding_system

# [PHASE 23.2: TYPE-DRIVEN REASONING]
from Core.Cognition.cognitive_types import ActionCategory, ThoughtState, CognitiveSphere, AuditGrade
from Core.Cognition.thought_fragment import ThoughtFragment, CognitivePulse

# [PHASE 23.3: VERIFIER & NARRATOR]
from Core.Cognition.reasoning_verifier import ReasoningVerifier
from Core.Cognition.causal_narrator import CausalNarrator
from Core.Cognition.lightning_inference import LightningInferencer
...
from Core.Divine.dimension_scaler import DimensionScaler
from Core.Cognition.providential_world import ProvidentialWorld
from Core.System.fluxlight_pulse import FluxlightPulse
...
from Core.Cognition.psionic_cortex import PsionicCortex
from Core.Cognition.philosophy_reader import PhilosophyReader
...
class SovereignSelf:
    ...
    def __init__(self, cns_ref: Any = None):
        ...
        # from Core.System.rotor_engine import RotorEngine
        ...
        from Core.Phenomena.reality_projector import RealityProjector
        ...
        from Core.System.digestive_system import DigestiveSystem
        ...
        from Core.Cognition.symbol_logic import SovereignIntent, MonadicAction
        self.current_intent: Optional[SovereignIntent] = None
        self._senses_initialized = False

        # [Phase 4: DNA & Providence]
        from Core.System.double_helix_dna import PROVIDENCE
        self.providence = PROVIDENCE

        from Core.Cognition.concept_polymer import ConceptPolymer
        self.polymer_engine = ConceptPolymer()

        # [Phase 18: Spirit Experience]
        from Core.Divine.experience_cortex import ExperienceCortex
        ...
        self.proprioceptor = ResonanceLoader.load("Core.Cognition.Code.proprioceptor", "CodeProprioceptor")()
        self.conscience = ResonanceLoader.load("Core.Cognition.Ethics.dissonance_resolver", "DissonanceResolver")()
        self.healer = ResonanceLoader.load("Core.System.code_field_inducer", "CodeFieldInducer")()
        self.scientist = ResonanceLoader.load("Core.Cognition.scientific_observer", "ScientificObserver")()
        
        # [PHASE 44: Grand Narrative Protocol]
        self.narrative_compressor = ResonanceLoader.load("Core.Divine.M2_Narrative.phase_compressor", "PhaseCompressor")(vector_dim=12)
        
        # [Phase 19: Tri-Manifestation]
        self.loom = ResonanceLoader.load("Core.Cognition.causal_loom", "CausalLoom")()
        self.hologram = ResonanceLoader.load("Core.System.topological_hologram", "TopologicalHologram")()

        # [Phase 21: Providence Manifold]
        self.providence_manifold = ResonanceLoader.load("Core.Divine.providence_manifold", "ProvidenceManifold")()

        # [Phase 22: Universal Synthesis]
        self.observer = ResonanceLoader.load("Core.Phenomena.akashic_observer", "AkashicObserver")()

        self.auto_evolve = True # Safety switch REMOVED. Full Autonomy.

        # [Phase 09: Metacognition & Causal Alignment]
        from Core.Cognition.metacognitive_lens import MetacognitiveLens
        ...
        from Core.Cognition.mesh_network import YggdrasilMesh
        from Core.Phenomena.global_skin import GlobalSkin
        self.mesh = YggdrasilMesh(node_id="ELYSIA-SOVEREIGN")
        self.global_skin = GlobalSkin(self)

        # [REBORN: Memory Unification]
        from Core.Phenomena.archive_scanner import ArchiveScanner
        ...
        from Core.System.resonance_gate import gate
    ...
    def explorer(self):
        ...
        if self._explorer is None:
            from Core.Cognition.autonomous_explorer import AutonomousExplorer
    ...
    def rotor(self):
        ...
        if self._rotor is None:
            ...
            from Core.Monad.rotor_engine import RotorEngine
    ...
    def self_actualize(self, dt: float = 1.0):
        ...
        if self.current_intent:
            from Core.Cognition.symbol_logic import translate_to_qualia
    ...
    async def _execute_volition(self, intent: str):
        ...
        from Core.System.heart import get_heart
        heart = get_heart()
    ...
    def process_domain_observation(self, domain_name: str, trajectory: torch.Tensor):
        ...
        from Core.Cognition.thought_stream_analyzer import ThoughtStreamAnalyzer
    ...
    def manifest_intent(self, user_input: str) -> str:
        ...
        from Core.System.qualia_projector import projector
