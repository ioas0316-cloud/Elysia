...
from Core.IntelligenceLayer.Intelligence.tool_discovery import ToolDiscoveryProtocol
...
class ReasoningEngine:
    ...
    def __init__(self):
        ...
        from Core.InteractionLayer.Interface.dialogue_interface import DialogueInterface
