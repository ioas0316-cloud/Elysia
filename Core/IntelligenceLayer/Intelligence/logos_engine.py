...
from Core.FoundationLayer.Foundation.fractal_concept import ConceptDecomposer # AXIOM INTEGRATION
from Core.FoundationLayer.Foundation.fractal_soul import SoulCrystal, WebState # NEW: Spidey Sense
