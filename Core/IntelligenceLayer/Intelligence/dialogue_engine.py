...
from Core.FoundationLayer.Foundation.language_cortex import LanguageCortex, ThoughtStructure, SyntaxEngine

from Core.IntelligenceLayer.Intelligence.integrated_cognition_system import get_integrated_cognition
from Core.IntelligenceLayer.Intelligence.system_self_awareness import SystemSelfAwareness
