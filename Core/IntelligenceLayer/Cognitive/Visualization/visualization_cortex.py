...
try:
    from Core.FoundationLayer.Foundation.gemini_api import generate_text, generate_image_from_text
except ImportError:
    generate_text = None
    generate_image_from_text = None

try:
    from Core.FoundationLayer.Foundation.Wave.wave_tensor import Tensor3D, FrequencyWave
except ImportError:
