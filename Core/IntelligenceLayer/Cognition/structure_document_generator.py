...
Usage:
    from Core.IntelligenceLayer.Cognition.structure_document_generator import StructureDocumentGenerator
...
try:
    from Core.IntelligenceLayer.Cognition.codebase_introspector import get_introspector, CodebaseIntrospector
    from Core.IntelligenceLayer.Cognition.why_how_explainer import get_explainer, WhyHowExplainer
except ImportError:
    # 직접 실행 시
