...
Usage:
    from Core.IntelligenceLayer.Physics_Waves.Wave import (
        analyze_code,
        detect_resonance,
        compress_to_dna,
        decompress_from_dna
...
# 핵심 시스템 임포트
try:
    from Core.IntelligenceLayer.Intelligence.wave_coding_system import (
...
try:
    from Core.FoundationLayer.Foundation.Wave.quaternion_wave_dna import (
...
# 품질 검사 함수 추가
try:
    from Core.IntelligenceLayer.Physics_Waves.Wave.quality_guard import WaveQualityGuard, QualityReport
