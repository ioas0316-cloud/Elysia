...
# 기존 시스템 통합
try:
    from Core.FoundationLayer.Foundation.spacetime_drive import SpaceTimeDrive, SpaceTimeState
    from Core.FoundationLayer.Foundation.causality_seed import Event, CausalType, SpacetimeCoord
