...
class ExplorationBridge:
    ...
    def __init__(self):
        ...
        try:
            from Core.FoundationLayer.Foundation.exploration_core import ExplorationCore
        ...
        self.naver = None
        try:
            from Core.InteractionLayer.Network.naver_connector import NaverSearchConnector
        ...
        try:
            from Core.FoundationLayer.Foundation.extreme_hyper_learning import KoreanEnglishMapper
    ...
    def _try_inner_dialogue(self, question: str) -> tuple:
        """내면 대화로 자체 추론 시도"""
        try:
            from Core.IntelligenceLayer.Consciousness.Consciousness.inner_dialogue import DeepContemplation
