...
if "c:/Elysia" not in sys.path:
    sys.path.insert(0, "c:/Elysia")

from Core.L6_Structure.M3_Sphere.wave_dna import WaveDNA
from Core.L1_Foundation.M1_Keystone.universal_constants import GOLDEN_RATIO, FREQ_LOVE, FREQ_TRUTH
from Core.L6_Structure.M5_Engine.governance_engine import GovernanceEngine
from Core.L4_Causality.M3_Mirror.Physics.sofa_optimizer import SofaPathOptimizer
from Core.L4_Causality.M3_Mirror.Physics.scalar_sensing import PPSSensor, ScalarField
