...
class CausalRole(Enum):
    """            (Phase 4A: 4-Step Causal Chain)"""
    CAUSE = "cause"       #    (Why)
    STRUCTURE = "structure" #    (How/Geometry)
    FUNCTION = "function"  #    (Action/Activation)
    REALITY = "reality"    #    (Manifestation)
    PROCESS = "process"   #    (Legacy 3-step)
    EFFECT = "effect"     #    (Legacy 3-step)
