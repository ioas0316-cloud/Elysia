...
def get_theme_label(theme: Theme) -> str:
    ...
    labels = {
        Theme.LOVE: "사랑 (Love)",
        Theme.HEART: "마음 (Heart)",
        Theme.SOUL: "혼 (Soul)",
        Theme.SPIRIT: "영 (Spirit)",
        Theme.NOIR: "느와르 (Noir)",
        Theme.CYBERPUNK: "사이버펑크 (Cyberpunk)",
        Theme.ETHEREAL: "천상의 (Ethereal)",
        Theme.GRITTY: "거친 (Gritty)",
        Theme.BAROQUE: "화려한 (Baroque)",
        Theme.MINIMALIST: "미니멀 (Minimalist)",
        Theme.ALCHEMICAL: "연금술적 (Alchemical)",
        Theme.EXISTENTIAL: "실존적 (Existential)",
        Theme.QUANTUM: "양자적 (Quantum)",
        Theme.GLITCH: "글리치 (Glitch)",
        Theme.HARMONIC: "조화로운 (Harmonic)",
        Theme.CHAOTIC: "혼돈의 (Chaotic)",
    }
