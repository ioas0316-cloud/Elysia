...
def phase_3_self_integration():
    ...
    try:
        from Core.L1_Foundation.M1_Keystone.Core_Logic.Elysia.Elysia.heart import get_heart
        from Core.L1_Foundation.M1_Keystone.Core_Logic.Elysia.Elysia.growth import get_growth
