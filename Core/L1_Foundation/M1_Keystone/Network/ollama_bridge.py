...
class OllamaBridge:
    ...
    Ollama    LLM     
       ...
       :
        from Core.L5_Mental.M1_Cognition.Intelligence.ollama_bridge import ollama
    ...
    def __init__(self, base_url: str = "http://localhost:11434", default_model: str = "llama3.2:3b"):
        ...
        from Core.L1_Foundation.M1_Keystone.google_free_connector import GoogleGeminiConnector
    ...
    def _check_availability(self):
        ...
        try:
            ...
            # Fallback
            from Core.L1_Foundation.M1_Keystone.tiny_brain import get_tiny_brain
