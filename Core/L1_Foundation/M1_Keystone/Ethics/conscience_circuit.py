...
# Import Ancient Laws
try:
    from Core.L1_Foundation.M1_Keystone.soul_guardian import SoulGuardian
    GUARDIAN_AVAILABLE = True
except ImportError:
    GUARDIAN_AVAILABLE = False

try:
    from Core.L1_Foundation.M1_Keystone.kg_manager import KGManager
    from Core.L1_Foundation.M1_Keystone.value_centered_decision import ValueCenteredDecision
    VCD_AVAILABLE = True
except ImportError:
    VCD_AVAILABLE = False
