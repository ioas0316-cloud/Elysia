...
from Core.L1_Foundation.M1_Keystone.external_data_connector import ExternalDataConnector
from Core.L1_Foundation.M1_Keystone.internal_universe import InternalUniverse

# Problem-solving learning imports
try:
    from Core.L5_Mental.M1_Cognition.Cognition.principle_distiller import PrincipleDistiller
...
try:
    from Core.L6_Structure.M3_Sphere.light_spectrum import get_light_universe, LightUniverse
except ImportError:
