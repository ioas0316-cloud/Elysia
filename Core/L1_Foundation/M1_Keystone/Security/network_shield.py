...
try:
    from Core.L6_Structure.M3_Sphere.resonance_field import ResonanceField, ResonanceNode
    from Core.L1_Foundation.M1_Keystone.physics import ResonanceGate, PhotonEntity
