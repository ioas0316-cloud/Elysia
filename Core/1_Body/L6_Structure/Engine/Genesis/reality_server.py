...
try:
    ...
    from Core.1_Body.L3_Phenomena.M4_Speech.logos_voice import LogosVoice
    from Core.1_Body.L3_Phenomena.Wave.logos_dna import LogosDNA
    from Core.1_Body.L5_Mental.Bridge.optical_conscious_bridge import OpticalConsciousBridge
    
    # L1: Hardware Sovereignty (Lightning Path)
    from Core.1_Body.L1_Foundation.Foundation.Optimization.lightning_path import LightningPath
