...
# Import Ancient Laws
try:
    from Core.1_Body.L1_Foundation.Foundation.soul_guardian import SoulGuardian
    GUARDIAN_AVAILABLE = True
except ImportError:
    GUARDIAN_AVAILABLE = False

try:
    from Core.1_Body.L1_Foundation.Foundation.kg_manager import KGManager
    from Core.1_Body.L1_Foundation.Foundation.value_centered_decision import ValueCenteredDecision
    VCD_AVAILABLE = True
except ImportError:
    VCD_AVAILABLE = False
