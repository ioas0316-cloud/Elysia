...
class OllamaBridge:
    ...
    Ollama    LLM     
       ...
       :
        from Core.1_Body.L5_Mental.Reasoning_Core.Intelligence.ollama_bridge import ollama
    ...
    def __init__(self, base_url: str = "http://localhost:11434", default_model: str = "llama3.2:3b"):
        ...
        from Core.1_Body.L1_Foundation.Foundation.google_free_connector import GoogleGeminiConnector
    ...
    def _check_availability(self):
        ...
        try:
            ...
            # Fallback
            from Core.1_Body.L1_Foundation.Foundation.tiny_brain import get_tiny_brain
