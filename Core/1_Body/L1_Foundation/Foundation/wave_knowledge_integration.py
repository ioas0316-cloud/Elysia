...
from Core.1_Body.L1_Foundation.Foundation.wave_semantic_search import WaveSemanticSearch

if TYPE_CHECKING:
    from Core.1_Body.L1_Foundation.Foundation.unified_knowledge_system import (
