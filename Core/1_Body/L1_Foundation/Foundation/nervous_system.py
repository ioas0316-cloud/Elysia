...
class NervousSystem:
    ...
    def __init__(self):
        ...
        from Core.1_Body.L4_Causality.World.Senses.spiritual_sensorium import get_spiritual_sensorium
    ...
    def _connect_internal_systems(self):
        ...
        try:
            from Core.1_Body.L1_Foundation.Foundation.central_cortex import CentralCortex
