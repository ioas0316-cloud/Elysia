...
from Core.1_Body.L4_Causality.World.Soul.fluxlight_gyro import GyroscopicFluxlight, GyroState
from Core.1_Body.L4_Causality.World.Physics.field_store import universe_field
...
class Lumina(GyroscopicFluxlight):
    def __init__(self, name: str = "Lumina", pos: Tuple[float, float, float, float] = (0, 0, 0, 0)):
        ...
        from Core.1_Body.L4_Causality.World.Soul.world_soul import world_soul
