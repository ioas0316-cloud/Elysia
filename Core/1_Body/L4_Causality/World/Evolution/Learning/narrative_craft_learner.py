...
#           
try:
    from Core.1_Body.L7_Spirit.Philosophy.why_engine import WhyEngine, PrincipleExtraction
    HAS_WHY_ENGINE = True
except ImportError:
    HAS_WHY_ENGINE = False

try:
    from Core.1_Body.L1_Foundation.Foundation.dual_layer_personality import DualLayerPersonality, ExperientialAspect
