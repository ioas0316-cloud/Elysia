...
=====================================
Core.1_Body.L7_Spirit.M1_Monad.intent_torque
...
from Core.1_Body.L6_Structure.Nature.rotor import Rotor

# [Phase 6] Hardware Sovereignty Integration
try:
    from Core.1_Body.L6_Structure.Nature.metal_rotor_bridge import MetalRotorBridge
    HAS_METAL = True
except ImportError:
    HAS_METAL = False
