...
class Elysia:
    ...
    def __init__(self, enable_inner_voice: bool = True):
        ...
        #   Heart (  ) -      .         .
        from Core.1_Body.L1_Foundation.Foundation.Core_Logic.Elysia.Elysia.heart import Heart
        self.heart = Heart()
        logger.info("  Heart beating... (            )")
        
        #   Growth (  ) -            
        from Core.1_Body.L1_Foundation.Foundation.Core_Logic.Elysia.Elysia.growth import Growth
        ...
        if enable_inner_voice:
            try:
                from Core.1_Body.L5_Mental.Reasoning_Core.Intelligence.inner_voice import InnerVoice, SelfAwareness
        ...
        from Core.1_Body.L1_Foundation.Foundation.tensor_dynamics import TensorDynamics
        ...
        from Core.1_Body.L5_Mental.Reasoning_Core.Intelligence.Logos.causality_seed import CausalitySeed
        from Core.1_Body.L7_Spirit.Philosophy.nature_of_being import PhilosophyOfFlow
        ...
        # 3. Evolution (  ) -             
        from Core.1_Body.L4_Causality.World.Evolution.Growth.Evolution.Evolution.autonomous_improver import AutonomousImprover
        from Core.1_Body.L4_Causality.World.Evolution.Growth.Evolution.Evolution.structural_unifier import StructuralUnifier
        ...
        # 4. Galaxy (   ) -       
        from Core.1_Body.L1_Foundation.Foundation.Core_Logic.Elysia.Elysia.galaxy import Galaxy
        self.galaxy = Galaxy(project_root=self.project_root)
        
        # 5. Interface (  )
        from Core.1_Body.L6_Structure.Engine.Governance.Interaction.Interface.conversation_engine import ConversationEngine
