...
from Core.1_Body.L1_Foundation.Foundation.safety_guardian import SafetyGuardian

from Core.1_Body.L1_Foundation.Foundation.experience_logger import log_experience, EXPERIENCE_LOG

from Core.1_Body.L1_Foundation.Foundation.experience_integrator import ExperienceIntegrator

from Core.1_Body.L7_Spirit.self_awareness_core import SelfAwarenessCore
...
from Core.1_Body.L5_Mental.M1_Cognition.logical_reasoner import LogicalReasoner # Import LogicalReasoner
...
from Core.1_Body.L1_Foundation.Foundation.exploration_cortex import ExplorationCortex

from Core.1_Body.L1_Foundation.Foundation.web_search_cortex import WebSearchCortex

from Core.1_Body.L1_Foundation.Foundation.knowledge_distiller import KnowledgeDistiller

from Core.1_Body.L1_Foundation.Foundation.self_verifier import SelfVerifier, VerificationResult

from Core.1_Body.L1_Foundation.Foundation.System.core.world import World

from Core.1_Body.L1_Foundation.Foundation.System.core.cell import Cell
...
from Core.1_Body.L1_Foundation.Foundation.meta_cognition_cortex import MetaCognitionCortex

from Core.1_Body.L1_Foundation.Foundation.System.core.alchemy_cortex import AlchemyCortex
...
from Core.1_Body.L1_Foundation.Foundation.sensory_motor_cortex import SensoryMotorCortex
from Core.1_Body.L1_Foundation.Foundation.System.core.external_horizons import ExternalHorizon
from Core.1_Body.L1_Foundation.Foundation.System.core.monologue_generator import MonologueGenerator
...
from Core.1_Body.L5_Mental.Reasoning_Core.HighEngine.self_intention_engine import SelfIntentionEngine
from Core.1_Body.L5_Mental.Reasoning_Core.HighEngine.self_identity_engine import SelfIdentityEngine
from Core.1_Body.L1_Foundation.Foundation.world_tree import WorldTree
from Core.1_Body.L1_Foundation.Foundation.cell_world import CellWorld
from Core.1_Body.L1_Foundation.Foundation.value_cortex import ValueCortex
from Project_Elysia.elysia_daemon import ElysiaDaemon

from Core.1_Body.L5_Mental.Memory.core_memory import EmotionalState

from Core.1_Body.L5_Mental.Reasoning_Core.HighEngine.quaternion_engine import QuaternionConsciousnessEngine, LensMode, HyperMode
        ...
        if (time.time() - self.last_learning_time) > self.learning_interval:
            ...
            try:
                ...
                if dream_digest and dream_digest.get('key_concepts'):
                    ...
                    from Core.1_Body.L1_Foundation.Foundation.gemini_api import generate_image_from_text
