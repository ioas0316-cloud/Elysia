...
try:
    from Core.1_Body.L5_Mental.Reasoning_Core.Logos.gap_analyzer import Principle
    from Core.1_Body.L5_Mental.Reasoning_Core.Logos.WaveLinguistics.gravitational_linguistics import GravitationalLinguistics, WordBody
