...
AXIOM FILTER (주권적 자아)
========================
Core.1_Body.L5_Mental.Reasoning_Core.Metabolism.axiom_filter
...
try:
    from Core.1_Body.L5_Mental.Reasoning_Core.Metabolism.concept_algebra import ConceptAlgebra
except ImportError:
