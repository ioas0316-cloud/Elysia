...
try:
    from Core.Sensory.real_frequency_database import RealSensoryFrequencyDatabase
    from Core.Sensory.five_senses_mapper import SensoryExperience, VisualProperties, AudioProperties
except ImportError:
