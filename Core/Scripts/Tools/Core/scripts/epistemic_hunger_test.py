...
from Core.1_Body.L1_Foundation.Foundation.causal_narrative_engine import ThoughtUniverse
from Core.1_Body.L1_Foundation.Foundation.gap_bridging import GapBridgingDrive
from Core.1_Body.L1_Foundation.Foundation.metacognition import GapReport
...
def run_hunger_demo():
    ...
    if True: # Using local ThoughtUniverse
        ...
        from Core.1_Body.L1_Foundation.Foundation.metacognition import CognitiveMetrics
        report = GapReport(
