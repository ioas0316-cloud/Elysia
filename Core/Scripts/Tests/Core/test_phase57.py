...
def test_patch_proposer():
    ...
    from Core.S1_Body.L5_Mental.Reasoning_Core.Meta.patch_proposer import PatchProposer, get_patch_proposer
...
def test_proposals_report():
    ...
    from Core.S1_Body.L5_Mental.Reasoning_Core.Meta.patch_proposer import get_patch_proposer
