...
class TestNervousSystem(unittest.TestCase):
    ...
    @patch('Core.L3_Phenomena.Senses.bio_sensor.psutil.sensors_temperatures')
    ...
    @patch('Core.L3_Phenomena.Senses.bio_sensor.psutil.cpu_percent')
    ...
    @patch('Core.L3_Phenomena.Senses.bio_sensor.psutil.virtual_memory')
