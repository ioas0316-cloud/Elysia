...
try:
    from Core._02_Intelligence._02_Memory_Linguistics.Memory.prism_filter import PrismFilter, RainbowSpectrum
...
try:
    from Core._01_Foundation.05_Foundation_Base.Foundation.fractal_quantization import PatternDNA, EmotionQuantizer
