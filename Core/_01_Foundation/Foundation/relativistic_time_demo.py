...
from Core._01_Foundation.05_Foundation_Base.Foundation.Physics.gravity import GravityEngine
from Core._01_Foundation.05_Foundation_Base.Foundation.Physics.meta_time_engine import MetaTimeCompressionEngine
