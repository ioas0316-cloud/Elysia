...
print(f'\n테스트: python -c "from Core._03_Interaction._02_Interface.Interface.Interface.Language.dialogue.dialogue_engine import DialogueEngine; d = DialogueEngine(); print(d.respond(\'사랑이 뭐니?\'))"')
