...
def phase_3_self_integration():
    ...
    try:
        from Core._01_Foundation._01_Core_Logic.Elysia.Elysia.heart import get_heart
        from Core._01_Foundation._01_Core_Logic.Elysia.Elysia.growth import get_growth
