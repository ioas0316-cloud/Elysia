...
class StructuralUnifier:
    ...
    def scan_resonance(self) -> Dict[str, Any]:
        ...
        from Core._01_Foundation._04_Governance.Foundation.resonance_field import ResonanceField, PillarType
        ...
        for source, target in connections:
            ...
            if target in field.nodes:
                ...
                # Try to find partial match (e.g. Core._01_Foundation -> Foundation)
                parts = target.split('.')
