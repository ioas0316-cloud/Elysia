...
class AutonomousExplorer:
    ...
    def __init__(self):
        ...
        try:
            from Core._01_Foundation.05_Foundation_Base.Foundation.internal_universe import get_internal_universe
    ...
    def explore_with_absorption(self, direction: Dict[str, Any]) -> List[ExplorationResult]:
        ...
        if connections > 0:
            ...
            # BlackHole에 압축 보존 시도
            try:
                from Core._01_Foundation.05_Foundation_Base.Foundation.black_hole import BlackHole
                blackhole = BlackHole()
                # 나중에 연결될 수 있으므로 보존
