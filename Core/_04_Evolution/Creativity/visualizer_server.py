...
class VisualizerServer:
    def __init__(self, world: Any, port: int = 8000):
        ...
        try:
            from Core._02_Intelligence._01_Reasoning.Intelligence.tool_executor import ToolExecutor
            self.tool_executor = ToolExecutor()
        except: pass

        # Phase 5: Reality Perception System Integration
        try:
            from Core._03_Interaction._01_Interface.Sensory.reality_perception import RealityPerceptionSystem
