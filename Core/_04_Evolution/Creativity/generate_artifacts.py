...
from Core._02_Intelligence.05_Science_Research.Science.bio_resonator import BioResonator
from Core._02_Intelligence.05_Science_Research.Science.quantum_resonator import QuantumResonator
