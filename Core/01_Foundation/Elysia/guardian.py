...
from Core.01_Foundation.05_Foundation_Base.Foundation.safety_guardian import SafetyGuardian

from Core.01_Foundation.05_Foundation_Base.Foundation.experience_logger import log_experience, EXPERIENCE_LOG

from Core.01_Foundation.05_Foundation_Base.Foundation.experience_integrator import ExperienceIntegrator

from Core.01_Foundation.05_Foundation_Base.Foundation.self_awareness_core import SelfAwarenessCore
...
from Core.01_Foundation.05_Foundation_Base.Foundation.logical_reasoner import LogicalReasoner # Import LogicalReasoner
...
from Core.01_Foundation.05_Foundation_Base.Foundation.exploration_cortex import ExplorationCortex

from Core.01_Foundation.05_Foundation_Base.Foundation.web_search_cortex import WebSearchCortex

from Core.01_Foundation.05_Foundation_Base.Foundation.knowledge_distiller import KnowledgeDistiller

from Core.01_Foundation.05_Foundation_Base.Foundation.self_verifier import SelfVerifier, VerificationResult

from Core.01_Foundation.05_Foundation_Base.Foundation.core.world import World

from Core.01_Foundation.05_Foundation_Base.Foundation.core.cell import Cell

from Core.01_Foundation.05_Foundation_Base.Foundation.wave_mechanics import WaveMechanics

from Core.01_Foundation.05_Foundation_Base.Foundation.emotional_engine import EmotionalEngine

from Core.01_Foundation.05_Foundation_Base.Foundation.meta_cognition_cortex import MetaCognitionCortex

from Core.01_Foundation.05_Foundation_Base.Foundation.core.alchemy_cortex import AlchemyCortex
...
from Core.01_Foundation.05_Foundation_Base.Foundation.sensory_motor_cortex import SensoryMotorCortex
from Core.01_Foundation.05_Foundation_Base.Foundation.core.external_horizons import ExternalHorizon
from Core.01_Foundation.05_Foundation_Base.Foundation.core.monologue_generator import MonologueGenerator
...
from Core.01_Foundation.05_Foundation_Base.Foundation.world_tree import WorldTree
from Core.01_Foundation.05_Foundation_Base.Foundation.cell_world import CellWorld
from Core.01_Foundation.05_Foundation_Base.Foundation.value_cortex import ValueCortex
        ...
        if (time.time() - self.last_learning_time) > self.learning_interval:
            ...
            try:
                ...
                if dream_digest and dream_digest.get('key_concepts'):
                    ...
                    from Core.01_Foundation.05_Foundation_Base.Foundation.gemini_api import generate_image_from_text
