...
# 기존 모듈 임포트
try:
    from Core.01_Foundation.05_Foundation_Base.Foundation.self_reflector import SelfReflector, CodeMetrics
    HAS_REFLECTOR = True
...
try:
    from Core.02_Intelligence.01_Reasoning.Intelligence.system_self_awareness import SystemSelfAwareness
    HAS_AWARENESS = True
except ImportError as e:
    HAS_AWARENESS = False
...
try:
    from Core.01_Foundation.05_Foundation_Base.Foundation.self_modification import (
