...
# 실제 모듈에서 모든 것을 가져옴
from Core.02_Intelligence.02_Memory_Linguistics.Memory.Vector.internal_universe import *
from Core.02_Intelligence.02_Memory_Linguistics.Memory.Vector.internal_universe import InternalUniverse, WorldCoordinate
