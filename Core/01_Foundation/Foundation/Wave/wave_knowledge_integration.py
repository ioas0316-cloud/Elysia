...
from Core.01_Foundation.05_Foundation_Base.Foundation.wave_semantic_search import WaveSemanticSearch

if TYPE_CHECKING:
    from Core.01_Foundation.05_Foundation_Base.Foundation.unified_knowledge_system import (
