...
try:
    from Core.FoundationLayer.Foundation.kg_manager import KGManager
    from Core.FoundationLayer.Foundation.value_centered_decision import ValueCenteredDecision
    VCD_AVAILABLE = True
except ImportError:
    VCD_AVAILABLE = False
