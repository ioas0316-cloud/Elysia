...
from Core.FoundationLayer.Foundation.safety_guardian import SafetyGuardian

from Core.FoundationLayer.Foundation.experience_logger import log_experience, EXPERIENCE_LOG

from Core.FoundationLayer.Foundation.experience_integrator import ExperienceIntegrator

from Core.FoundationLayer.Foundation.self_awareness_core import SelfAwarenessCore
...
from Core.FoundationLayer.Foundation.logical_reasoner import LogicalReasoner # Import LogicalReasoner
...
from Core.FoundationLayer.Foundation.knowledge_distiller import KnowledgeDistiller

from Core.FoundationLayer.Foundation.self_verifier import SelfVerifier, VerificationResult
...
from Core.FoundationLayer.Foundation.meta_cognition_cortex import MetaCognitionCortex
...
from Core.FoundationLayer.Foundation.sensory_motor_cortex import SensoryMotorCortex
from Core.FoundationLayer.Foundation.core.external_horizons import ExternalHorizon
from Core.FoundationLayer.Foundation.core.monologue_generator import MonologueGenerator
        ...
        if (time.time() - self.last_learning_time) > self.learning_interval:
            ...
            try:
                ...
                if dream_digest and dream_digest.get('key_concepts'):
                    ...
                    from Core.FoundationLayer.Foundation.gemini_api import generate_image_from_text
