...
try:
    from Core.SystemLayer.System.System.Kernel import kernel
except ImportError:
...
try:
    from Core.EvolutionLayer.Growth.Evolution.Evolution.Life.symphony_engine import SymphonyEngine
except ImportError:
            ...
            for event in pygame.event.get():
                ...
                # Handle Control Keys
                    ...
                    if event.key == pygame.K_RETURN:
                        ...
                        from Core.FoundationLayer.Foundation.visualize_memory import visualize_memory
