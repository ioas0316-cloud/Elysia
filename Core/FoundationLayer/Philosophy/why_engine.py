...
# 기존 파동 센서 시스템 활용
try:
    from Core.FoundationLayer.Foundation.synesthesia_engine import SynesthesiaEngine, SignalType
    from Core.FoundationLayer.Foundation.Wave.phonetic_resonance import PhoneticResonanceEngine, get_resonance_engine
...
try:
    ...
    from Core.FoundationLayer.Foundation.light_spectrum import LightSediment, PrismAxes, LightUniverse
except ImportError:
    HyperQubit = None
    QubitState = None
    LightSediment = None
...
class WhyEngine:
    ...
    def _analyze_sediment(self, content: str, subject_tag: str = "") -> Dict[str, Any]:
        ...
        from Core.FoundationLayer.Foundation.light_spectrum import PrismAxes
