...
class Elysia:
    ...
    def __init__(self, enable_inner_voice: bool = True):
        ...
        #   Heart (  ) -      .         .
        from Core.System.Core_Logic.Elysia.Elysia.heart import Heart
        self.heart = Heart()
        logger.info("  Heart beating... (            )")
        
        #   Growth (  ) -            
        from Core.System.Core_Logic.Elysia.Elysia.growth import Growth
        ...
        if enable_inner_voice:
            try:
                from Core.Cognition.inner_voice import InnerVoice, SelfAwareness
        ...
        from Core.System.tensor_dynamics import TensorDynamics
        self.resonance_field = ResonanceField()
        self.physics = TensorDynamics(root_path=self.project_root)
        
        # 2. Intelligence (  )
        from Core.Cognition.free_will_engine import FreeWillEngine
        from Core.Cognition.causality_seed import CausalitySeed
        from Core.Divine.nature_of_being import PhilosophyOfFlow
        ...
        # 3. Evolution (  ) -             
        from Core.Cognition.Evolution.Evolution.autonomous_improver import AutonomousImprover
        from Core.Cognition.Evolution.Evolution.structural_unifier import StructuralUnifier
        ...
        # 4. Galaxy (   ) -       
        from Core.System.Core_Logic.Elysia.Elysia.galaxy import Galaxy
