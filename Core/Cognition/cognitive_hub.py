...
try:
    from Core.Cognition.principle_distiller import get_principle_distiller, PrincipleDistiller
...
try:
    from Core.Intelligence.Logos.philosophical_core import PhilosophicalCore
