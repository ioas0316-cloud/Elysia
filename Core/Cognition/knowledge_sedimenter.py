...
from Core.System.browser_explorer import BrowserExplorer
from Core.Divine.why_engine import WhyEngine
from Core.Keystone.light_spectrum import LightSpectrum, LightSediment, PrismAxes
...
class KnowledgeSedimenter:
    ...
    def sediment_from_web(self, topic: str, max_pages: int = 1) -> List[LightSpectrum]:
        ...
        for res in search_results["results"][:max_pages]:
            ...
            try:
                from Core.Cognition.dimensional_reasoner import DimensionalReasoner
