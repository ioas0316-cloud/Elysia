...
from Core.Cognition.Studio.concept_atelier import ConceptAtelier, RawMaterial
from Core.Cognition.integrated_cognition_system import ThoughtWave, Quaternion
