...
from Core.Cognition.Science_Research.Science.bio_resonator import BioResonator
from Core.Cognition.Science_Research.Science.quantum_resonator import QuantumResonator
from Core.Cognition.Studio.bio_choir import BioChoir
from Core.Cognition.Studio.video_composer import VideoComposer
