...
from Core.Cognition.llm_observer import get_llm_observer, LLMCrystal
from Core.Cognition.llm_crystallizer import get_llm_crystallizer, digest_llm
from Core.Cognition.llm_pruner import get_llm_pruner
