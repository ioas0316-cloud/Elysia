...
# from Core.01_Foundation.04_Philosophy.Philosophy.ideal_self_profile import IdealSelfProfile, SoulFrequency # TODO: Migrate Philosophy
...
class ReasoningEngine:
    ...
    def hippocampus(self):
        if not hasattr(self, '_hippocampus') or not self._hippocampus:
             try:
                 from Core.Memory.Graph.hippocampus import Hippocampus
