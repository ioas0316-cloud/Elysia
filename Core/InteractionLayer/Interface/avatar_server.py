...
try:
    ...
    from Core.FoundationLayer.Foundation.spirit_emotion import SpiritEmotionMapper
...
try:
    ...
    try:
        # Legacy path
        from Core.IntelligenceLayer.Intelligence.Reasoning.reasoning_engine import ReasoningEngine
...
try:
    from Core.FoundationLayer.Foundation.avatar_physics import AvatarPhysicsEngine, Vector3D
...
class ElysiaAvatarCore:
    ...
    def __init__(self):
        ...
        try:
            from Core.InteractionLayer.Interface.avatar_voice_tts import AvatarVoiceTTS
        ...
        try:
            from Core.InteractionLayer.Interface.avatar_lipsync import LipSyncEngine
    ...
    async def process_chat(self, message: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if hasattr(self.reasoning_engine, 'decide_action'):
                ...
                from Core.IntelligenceLayer.Intelligence.reasoning_engine import Tool
...
class AvatarWebSocketServer:
    ...
    def __init__(self, host: str = "127.0.0.1", port: int = 8765, require_auth: bool = False, enable_monitoring: bool = True):
        ...
        try:
            from Core.InteractionLayer.Interface.avatar_security import create_security_manager
        ...
        if enable_monitoring:
            try:
                from Core.InteractionLayer.Interface.avatar_monitoring import create_performance_monitor
