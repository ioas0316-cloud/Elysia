...
from Core.InteractionLayer.Sensory.stream_manager import StreamManager
from Core.InteractionLayer.Sensory.ego_anchor import EgoAnchor, SelectiveMemory
from Core.FoundationLayer.Foundation.wave_semantic_search import WaveSemanticSearch, WavePattern
from Core.FoundationLayer.Foundation.hyper_quaternion import Quaternion
from Core.FoundationLayer.Foundation.internal_universe import InternalUniverse, WorldCoordinate # NEW
from Core.EvolutionLayer.Learning.Learning.language_learner import LanguageLearner
from Core.EvolutionLayer.Learning.Learning.wave_pattern_learner import WavePatternLearner  # AUTONOMOUS LEARNING
