...
# 기존 시스템 통합
try:
    from Core.01_Foundation.05_Foundation_Base.Foundation.spacetime_drive import SpaceTimeDrive, SpaceTimeState
    from Core.01_Foundation.05_Foundation_Base.Foundation.causality_seed import Event, CausalType, SpacetimeCoord
