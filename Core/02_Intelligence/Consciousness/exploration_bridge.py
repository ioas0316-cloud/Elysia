...
class ExplorationBridge:
    ...
    def __init__(self):
        ...
        try:
            from Core.01_Foundation.05_Foundation_Base.Foundation.exploration_core import ExplorationCore
        ...
        self.naver = None
        try:
            from Core.03_Interaction.04_Network.Network.naver_connector import NaverSearchConnector
        ...
        try:
            from Core.01_Foundation.05_Foundation_Base.Foundation.extreme_hyper_learning import KoreanEnglishMapper
    ...
    def _try_inner_dialogue(self, question: str) -> tuple:
        """내면 대화로 자체 추론 시도"""
        try:
            from Core.02_Intelligence.04_Consciousness.Consciousness.inner_dialogue import DeepContemplation
