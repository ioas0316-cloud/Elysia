...
class ConversationMaturator:
    ...
    def context_retrieval(self):
        ...
        if self._context_retrieval is None:
            try:
                from Core.02_Intelligence.01_Reasoning.Cognition.context_retrieval import ContextRetrieval
    ...
    def inner_dialogue(self):
        ...
        if self._inner_dialogue is None:
            try:
                from Core.02_Intelligence.04_Consciousness.Consciousness.inner_dialogue import InnerDialogue
