...
from Core.01_Foundation.05_Foundation_Base.Foundation.kenosis_protocol import KenosisProtocol
from Core.02_Intelligence.01_Reasoning.Intelligence.web_cortex import WebCortex
from Core.02_Intelligence.01_Reasoning.Intelligence.tool_discovery import ToolDiscoveryProtocol
...
class ReasoningEngine:
    ...
    def __init__(self):
        ...
        from Core.03_Interaction.01_Interface.Interface.dialogue_interface import DialogueInterface
