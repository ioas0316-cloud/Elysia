...
from Core.01_Foundation.05_Foundation_Base.Foundation.reasoning_engine import Insight
from Core.01_Foundation.05_Foundation_Base.Foundation.Math.wave_tensor import WaveTensor
from Core.01_Foundation.05_Foundation_Base.Foundation.fractal_concept import ConceptDecomposer # AXIOM INTEGRATION
from Core.01_Foundation.05_Foundation_Base.Foundation.fractal_soul import SoulCrystal, WebState # NEW: Spidey Sense
