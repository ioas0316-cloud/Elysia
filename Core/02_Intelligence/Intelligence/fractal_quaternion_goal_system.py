...
try:
    from Core.02_Intelligence.01_Reasoning.Intelligence.integrated_cognition_system import get_integrated_cognition, IntegratedCognitionSystem
except ImportError:
...
try:
    ...
    from Core.01_Foundation.05_Foundation_Base.Foundation.ether import Wave, ether
except ImportError:
