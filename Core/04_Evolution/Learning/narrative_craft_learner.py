...
# 기존 시스템 임포트
try:
    from Core.01_Foundation.04_Philosophy.Philosophy.why_engine import WhyEngine, PrincipleExtraction
    HAS_WHY_ENGINE = True
except ImportError:
    HAS_WHY_ENGINE = False

try:
    from Core.01_Foundation.05_Foundation_Base.Foundation.dual_layer_personality import DualLayerPersonality, ExperientialAspect
