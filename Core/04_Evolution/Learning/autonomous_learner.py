...
from Core.04_Evolution.02_Learning.Learning.hierarchical_learning import Domain

sys.path.insert(0, str(Path(__file__).parent.parent.parent))

from Core.01_Foundation.04_Philosophy.Philosophy.why_engine import WhyEngine
from Core.02_Intelligence.01_Reasoning.Cognition.metacognitive_awareness import MetacognitiveAwareness, KnowledgeState
