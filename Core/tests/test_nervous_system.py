...
from Core.Senses.bio_sensor import BioSensor
...
class TestNervousSystem(unittest.TestCase):
    ...
    @patch('Core.Senses.bio_sensor.psutil.sensors_temperatures')
    ...
    @patch('Core.Senses.bio_sensor.psutil.cpu_percent')
    ...
    @patch('Core.Senses.bio_sensor.psutil.virtual_memory')
