...
try:
    ...
    from Core.01_Foundation.05_Foundation_Base.Foundation.spirit_emotion import SpiritEmotionMapper
...
try:
    ...
    try:
        # Legacy path
        from Core.02_Intelligence.01_Reasoning.Intelligence.Reasoning.reasoning_engine import ReasoningEngine
...
try:
    from Core.01_Foundation.05_Foundation_Base.Foundation.avatar_physics import AvatarPhysicsEngine, Vector3D
...
class ElysiaAvatarCore:
    ...
    def __init__(self):
        ...
        try:
            from Core.03_Interaction.01_Interface.Interface.avatar_voice_tts import AvatarVoiceTTS
        ...
        try:
            from Core.03_Interaction.01_Interface.Interface.avatar_lipsync import LipSyncEngine
    ...
    async def process_chat(self, message: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if hasattr(self.reasoning_engine, 'decide_action'):
                ...
                from Core.02_Intelligence.01_Reasoning.Intelligence.reasoning_engine import Tool
...
class AvatarWebSocketServer:
    ...
    def __init__(self, host: str = "127.0.0.1", port: int = 8765, require_auth: bool = False, enable_monitoring: bool = True):
        ...
        try:
            from Core.03_Interaction.01_Interface.Interface.avatar_security import create_security_manager
        ...
        if enable_monitoring:
            try:
                from Core.03_Interaction.01_Interface.Interface.avatar_monitoring import create_performance_monitor
