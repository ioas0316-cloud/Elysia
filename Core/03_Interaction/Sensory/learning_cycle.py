...
from Core.03_Interaction.01_Interface.Sensory.stream_manager import StreamManager
from Core.03_Interaction.01_Interface.Sensory.ego_anchor import EgoAnchor, SelectiveMemory
from Core.01_Foundation.05_Foundation_Base.Foundation.wave_semantic_search import WaveSemanticSearch, WavePattern
from Core.01_Foundation.05_Foundation_Base.Foundation.hyper_quaternion import Quaternion
from Core.01_Foundation.05_Foundation_Base.Foundation.internal_universe import InternalUniverse, WorldCoordinate # NEW
from Core.04_Evolution.02_Learning.Learning.language_learner import LanguageLearner
from Core.04_Evolution.02_Learning.Learning.wave_pattern_learner import WavePatternLearner  # AUTONOMOUS LEARNING
