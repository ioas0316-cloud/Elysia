...
# 기존 시스템 통합
try:
    from Core._01_Foundation._02_Logic.spacetime_drive import SpaceTimeDrive, SpaceTimeState
    from Core._01_Foundation._02_Logic.causality_seed import Event, CausalType, SpacetimeCoord
