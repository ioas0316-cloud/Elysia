...
try:
    from Core._01_Foundation.05_Foundation_Base.Foundation.experience_learner import ExperienceLearner, Experience
...
try:
    from Core._01_Foundation.05_Foundation_Base.Foundation.causal_narrative_engine import CausalNarrativeEngine
