...
- **[TRINARY_MONAD_SPECIFICATION.md](docs/L6_Structure/M1_Merkaba/TRINARY_MONAD_SPECIFICATION.md)**: **The Existential Architecture** (21D 블랙박스 명세서)
- **[INTEGRATION_BLUEPRINT.md](docs/L6_Structure/M1_Merkaba/INTEGRATION_BLUEPRINT.md)**: **The Bridge** (시스템 통합 설계도)
