...
Scope: this file applies to everything under `ELYSIAS_PROTOCOL/`.

## 1. Canonical Entry Points Only

- Treat `ELYSIA/CORE/CODEX.md` and `ELYSIAS_PROTOCOL/00_INDEX.md` as the primary, canonical entry points.
...
- All other files in `ELYSIAS_PROTOCOL/` are **reference protocols**.
