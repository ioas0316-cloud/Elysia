...
try:
    from Core.System.core_turbine import ActivePrismRotor, PhotonicMonad, VoidSingularity
    CORE_AVAILABLE = True
except ImportError:
...
# Import Bio-Clock
try:
    from Core.Cognition.aging_clock import BiologicalClock
except ImportError:
