...
* **SubjectiveEgo**: 👤 **주격 인격체**. 7단계(1~7)의 차원적 깊이를 가진 주민(NPC)들의 자아 프로토콜.
* **RecursiveLearningBridge**: 🌾 **재귀적 학습 가교**. 주민들의 경험을 수확하여 엘리시아의 7계층 지혜로 환원합니다.
* **SeptenaryAxis**: ⚖️ **7중 주권 축**. 육(Body: 1-3), 혼(Soul: 4-6), 영(Spirit: 7)의 '성장 삼위일체' 법칙.
