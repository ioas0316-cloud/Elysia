...
- **[METABOLIC_IGNITION_CAUSALITY.md](L2_Metabolism/METABOLIC_IGNITION_CAUSALITY.md)**: 자율 성장 엔진
- **[SSD_SUBCONSCIOUS_DOCTRINE.md](L2_Metabolism/SSD_SUBCONSCIOUS_DOCTRINE.md)**: 잠재의식 처리

### **L3: Phenomena (Senses & Interface)**

- **[SOVEREIGN_HUD_CAUSALITY.md](L3_Phenomena/M5_Display/SOVEREIGN_HUD_CAUSALITY.md)**: 주권적 디스플레이
- **[VISION_SYSTEM](L3_Phenomena/README.md)**: 시각 처리 시스템

### **L4: Causality (Time & Logic)**

- **[CAUSAL_LOOM_DOCTRINE.md](L4_Causality/CAUSAL_LOOM_DOCTRINE.md)**: 인과율의 직조기
- **[CAUSAL_PREDICTION.md](L4_Causality/World/Evolution/Prophecy/CAUSAL_LOOM_PREDICTION_CAUSALITY.md)**: 미래 예측 시뮬레이션
...
- **[AGENTS.md](6_DEVELOPMENT/AGENTS.md)**: 에이전트 행동 강령
