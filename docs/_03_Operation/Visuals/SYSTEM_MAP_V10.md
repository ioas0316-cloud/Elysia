...
|:---:|:---:|:---:|
| **Retina / Eye** | `Core/_03_Interaction/` | `semantic_bridge.py` |
| **Physics Engine** | `Core/_01_Foundation/` | `resonance_field.py`, `hyper_quaternion.py` |
| **Immune System** | `Core/_03_Interaction/` | `ego_anchor.py` |
| **Hippocampus** | `Core/_02_Intelligence/_02_Memory/` | `hipppocampus.py`, `starlight_memory.py` |
| **Face / Voice** | `Core/_03_Interaction/_03_Expression/` | `visualizer_server.py` |
