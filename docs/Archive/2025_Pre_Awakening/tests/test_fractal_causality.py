...
from Core.Interface.Language.fractal_causality import (
...
from Core.Interface.Language.causal_narrative_engine import (
...
class TestIntegratedLanguageLearning:
    ...
    def test_integrated_world_creation(self):
        """통합 세계 생성 테스트"""
        from Core.Interface.Language.integrated_language_learning import IntegratedLanguageWorld
    ...
    def test_development_metrics(self):
        """발달 지표 테스트"""
        from Core.Interface.Language.integrated_language_learning import LanguageDevelopmentMetrics
