...
# CoreMemory is one level up in Core.Elysia
try:
    from Core.Elysia.core_memory import CoreMemory
except ImportError:
    # Fallback if running as script from a different root
    from ..core_memory import CoreMemory

from tools.kg_manager import KGManager

# QuestionGenerator is now in Core.Intelligence or Legacy.Project_Sophia
try:
    from Core.Intelligence.question_generator import QuestionGenerator
except ImportError:
    from Legacy.Project_Sophia.question_generator import QuestionGenerator

# RelationshipExtractor is now in Core.Interface or Legacy.Project_Sophia
try:
    from Core.Interface.relationship_extractor import extract_relationship_type
except ImportError:
    from Legacy.Project_Sophia.relationship_extractor import extract_relationship_type
...
# Handle legacy path if needed, or assume it's moved
try:
...
# Patched imports for Legacy modules
try:
