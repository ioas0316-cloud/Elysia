...
Usage:
    from Core.Intelligence.Cognition.structure_document_generator import StructureDocumentGenerator
...
try:
    from Core.Intelligence.Cognition.codebase_introspector import get_introspector, CodebaseIntrospector
    from Core.Intelligence.Cognition.why_how_explainer import get_explainer, WhyHowExplainer
except ImportError:
    # 직접 실행 시
