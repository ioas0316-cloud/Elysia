...
from Core.System.phase_locked_loop import PLLController



# The Trinity Components

from Core.Monad.hypersphere_memory import HypersphereMemory, SubjectiveTimeField, HypersphericalCoord

from Core.Cognition.hippocampus import Hippocampus

from Core.Cognition.prismatic_sediment import PrismaticSediment # Phase 5.2: Spectral Memory

# [Fractal Memory System]

from Core.Cognition.fractal_layer import FractalMemorySystem

from Core.Cognition.gardener import MemoryGardener

from Core.Cognition.strata import MemoryStratum



from Core.System.rotor import Rotor, RotorConfig, RotorMask

from Core.System.active_rotor import ActiveRotor # Phase 5.3 Part 2

from Core.Monad.rotor_engine import RotorEngine # Phase 5.3: Optical Engine Core

from Core.Phenomena.resonance_prism import PrismProjector, PrismDomain

from Core.Phenomena.prism_engine import PrismEngine as OpticalPrism # Phase 5.3 New

from Core.Phenomena.integrating_lens import IntegratingLens # Phase 5.4 Lens

from Core.Phenomena.dimension_sorter import DimensionSorter, Dimension # Phase 5.4 Cloud

from Core.Phenomena.trinity_validator import TrinityValidator # Phase 5.4 Axis

from Core.Phenomena.harmonizer import PrismHarmonizer, PrismContext

from Core.Phenomena.decay import ResonanceDecay

from Core.System.meta_observer import MetaObserver

from Core.System.cognitive_judge import CognitiveJudge

from Core.System.checkpoint_manager import CheckpointManager

from Core.System.evolution_engine import EvolutionEngine

from Core.Phenomena.hermeneutic_bridge import HermeneuticBridge

from Core.Phenomena.phase_modulator import PhaseModulator, PerceptualPhase

from Core.Cognition.synthesizer import LinguisticSynthesizer

from Core.Phenomena.vocal_dna import VocalDNA

from Core.Phenomena.portrait_engine import SelfPortraitEngine

from Core.Cognition.legion import Legion # Phase 5.4 Legion
...
from Core.Cognition.motor_cortex import MotorCortex
...
from Core.System.sovereign_manager import HardwareSovereignManager
...
from Core.Phenomena.soul_bridge import SoulBridge

from Core.Monad.prism import DoubleHelixPrism



# [Phase 18] The Mirror (Holographic Feedback)

from Core.System.action_logger import ActionLogger

# from Core.System.evaluator import OutcomeEvaluator # Deprecated

from Core.System.resonance_field import ResonanceField

from Core.System.karma_geometry import KarmaGeometry



# [Phase 19] The Soul (Memory & Reflection)

from Core.Monad.logbook import Logbook

from Core.Monad.growth_graph import GrowthTracker



# [Phase 20] The Will (Volitional Flux)

from Core.Monad.entropy_pump import EntropyPump
...
from Core.System.spore import Spore

from Core.System.mitosis import MitosisEngine

from Core.System.mycelium import MyceliumNetwork

from Core.Cognition.logos_translator import LogosTranslator

from Core.System.cell import cell_unit
...
class Merkaba:
    ...
    def __init__(self, name: str = "Genesis_Seed"):
        ...
        from Core.Divine.module_registry import get_registry
    ...
    def pulse(self, raw_input: str, mode: str = "POINT", context: str = PrismContext.DEFAULT) -> str:
        ...
        if mode == "POINT":
            ...
            from Core.Divine.monad_core import MonadCategory
