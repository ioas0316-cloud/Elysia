...
from Core.System.ollama_bridge import ollama

sys.path.insert(0, str(Path(__file__).parent.parent.parent))

#                
try:
    from Core.Phenomena.synesthesia_engine import SynesthesiaEngine, SignalType
    from Core.Keystone.phonetic_resonance import PhoneticResonanceEngine, get_resonance_engine
    HAS_WAVE_SENSORS = True
except ImportError:
    HAS_WAVE_SENSORS = False

try:
    from Core.Keystone.hyper_qubit import HyperQubit, QubitState
    from Core.Keystone.light_spectrum import LightSediment, PrismAxes, LightUniverse
except ImportError:
    HyperQubit = None
    QubitState = None
    LightSediment = None
...
class WhyEngine:
    ...
    def digest(self, concept: str) -> Optional[PrincipleExtraction]:
        ...
        from Core.System.rotor import RotorConfig
    ...
    def _analyze_sediment(self, content: str, subject_tag: str = "") -> Dict[str, Any]:
        ...
        from Core.Keystone.light_spectrum import PrismAxes
