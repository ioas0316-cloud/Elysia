...
class Blueprint:
    ...
    structure: Dict[str, str] # {module_name: action} (e.g., 'Core.System': 'Keep')
...
class EvolutionArchitect:
    ...
    def __init__(self, cns_ref=None):
        ...
        try:
            from Core.Cognition.Autonomy.self_modifier_v2 import get_self_modifier
    ...
    def design_seed(self, intent: str = "Wisdom") -> Blueprint:
        ...
        if faults:
            ...
            structure["Core.Cognition"] = "Refactor (Restore Flow)"
