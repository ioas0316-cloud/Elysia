...
Usage:
    from Core.Cognition.Autonomy.self_documenter import SelfDocumenter
...
class SelfDocumenter:
    ...
    def _init_tools(self):
        ...
        try:
            from Core.Cognition.Memory_Linguistics.Memory.self_discovery import SelfDiscovery
            self.discovery = SelfDiscovery()
        except Exception as e:
            print(f"   SelfDiscovery not available: {e}")
        
        try:
            from Core.Cognition.why_how_explainer import get_explainer
