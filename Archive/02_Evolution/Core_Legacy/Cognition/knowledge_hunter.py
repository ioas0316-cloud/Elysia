...
from Core.System.search_tendril import SearchTendril
from Core.Cognition.external_digester import ExternalDigester
...
class KnowledgeHunter:
    ...
    def hunt(self, topic: str) -> str:
        ...
        from Core.Cognition.Cognitive.curiosity_core import get_curiosity_core
