...
Usage:
    ...
    #        
    from Core.Cognition.Physics_Waves.Wave.quality_guard import WaveQualityGuard
...
#    
try:
    from Core.Cognition.wave_coding_system import get_wave_coding_system, CodeWave
    WAVE_AVAILABLE = True
except ImportError:
