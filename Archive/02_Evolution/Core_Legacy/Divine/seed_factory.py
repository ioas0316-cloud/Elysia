...
from Core.Divine.monad_core import Monad, FractalRule
from Core.Divine.principles import ThermodynamicsRule, FluidDynamicsRule, OpticsRule, SemanticsRule, LinguisticsRule, SociologyRule
