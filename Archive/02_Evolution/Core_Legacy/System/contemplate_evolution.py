...
from Core.System.purpose_discovery_engine import PurposeDiscoveryEngine, DimensionalPerspective
from Core.Cognition.thought_space import ThoughtSpace, ThoughtParticle
