...
from Core.System.Orchestra.conductor import get_conductor, Tempo, Mode
from Core.System.Orchestra.synapse_manager import SynapseManager
from Core.Cognition.interference_engine import InterferenceEngine, Principle
from Core.Cognition.phase_stratum import PhaseStratum
...
def wake_up_and_live():
    ...
    from Core.Cognition.simulator import get_simulator
