...
from Core.Monad.sovereign_rotor_prototype import SovereignRotor
...
class SovereignSelf:
    ...
    def __init__(self, cns_ref: Any = None):
        ...
        self.providence = ResonanceLoader.load("Core.Divine.providence_manifold", "ProvidenceManifold")()
