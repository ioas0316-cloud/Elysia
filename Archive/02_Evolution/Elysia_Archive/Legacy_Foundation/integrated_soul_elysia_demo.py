...
# 시스템 임포트
from Core.Interaction.Interface.Language.fluctlight_language import FractalSoul, LanguageCrystal
from Core.Interaction.Interface.Language.language_bridge import LanguageBridge, EmergentPattern
